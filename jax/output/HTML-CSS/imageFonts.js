  ...
  HUB.Register.LoadHook(HTMLCSS.fontDir + "/fontdata.js", function() {
    HTMLCSS.Augment({
      ...
      handleImg: function(span, font, c, n, text) {
        ...
        var style = {
          width: Math.floor(img[0] / bscale + 0.5) + "px",
          height: Math.floor(img[1] / bscale + 0.5) + "px"
        };
        if (img[2]) {
          style.verticalAlign = Math.floor(-img[2] / bscale + 0.5) + "px";
        }
        if (c[3] < 0) {
    ...
    MathJax.Callback.Queue(["Require", AJAX, IMGDIR + "/imagedata.js"], GETWIDTHS, [
      "loadComplete",
      AJAX,
      HTMLCSS.directory + "/imageFonts.js"
    ]);
  });
