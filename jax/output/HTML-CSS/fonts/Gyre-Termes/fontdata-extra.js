...
(function(HTMLCSS) {
  ...
  var delim = {
    0x306: {
      dir: H,
      HW: [[0.35, MAIN], [0.62, SIZE1], [0.74, SIZE2], [0.885, SIZE3], [1.058, SIZE4], [1.266, SIZE5], [1.515, SIZE6]]
    },
    0x311: {
      dir: H,
      HW: [[0.35, MARKS], [0.62, SIZE1], [0.74, SIZE2], [0.885, SIZE3], [1.058, SIZE4], [1.266, SIZE5], [1.515, SIZE6]]
    },
    0x32c: {
      dir: H,
      HW: [
    ...
    0x20e9: {
      dir: H,
      HW: [[0.375, MARKS], [0.75, SIZE1], [1.125, SIZE2], [1.5, SIZE3], [1.875, SIZE4], [2.25, SIZE5], [2.625, SIZE6]],
    ...
    0x23b4: {
      dir: H,
      HW: [[0.375, MAIN], [0.75, SIZE1], [1.125, SIZE2], [1.5, SIZE3], [1.875, SIZE4], [2.25, SIZE5], [2.625, SIZE6]],
      stretch: { left: [0xe11b, SIZE6], rep: [0xe11c, SIZE6], right: [0xe11d, SIZE6] }
    },
    0x23b5: {
      dir: H,
