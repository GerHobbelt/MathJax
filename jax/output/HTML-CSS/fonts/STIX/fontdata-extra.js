...
(function(HTMLCSS) {
  ...
  var delim = {
    ...
    0x21a4: {
      dir: H,
      HW: [[0.926, GENERAL]],
      stretch: { left: [0x2190, VARIANT], rep: [0x2212, GENERAL], right: [0x22a3, BOLD, 0, 0.1, 0.6] }
    },
    // up arrow from bar
    0x21a5: {
      dir: V,
      HW: [[0.816, GENERAL]],
      stretch: { bot: [0x5f, GENERAL, 0.05, -0.01, 0.8], ext: [0x23d0, GENERAL], top: [0x2191, GENERAL] }
    },
    ...
    0x21a7: {
      dir: V,
      HW: [[0.816, GENERAL]],
      stretch: { top: [0x22a4, BOLD, 0.04, 0, 0.6], ext: [0x23d0, GENERAL], bot: [0x2193, GENERAL] }
    },
    ...
    0x23b4: {
      dir: H,
      HW: [[0.926, GENERAL], [1.063, SIZE1], [1.606, SIZE2], [2.147, SIZE3], [2.692, SIZE4], [3.237, SIZE5]],
      stretch: { left: [0x2310, GENERAL], rep: [0x2212, GENERAL, 0, 0.12], right: [0xac, GENERAL] }
    },
    ...
    0x23dc: {
      dir: H,
      HW: [[0.926, SIZE1], [1, GENERAL], [1.46, SIZE2], [1.886, SIZE3], [2.328, SIZE4], [3.237, SIZE5]],
    ...
    0x23e0: {
      dir: H,
      HW: [[1, GENERAL], [1.46, SIZE1], [1.886, SIZE2], [2.312, SIZE3], [2.738, SIZE4], [3.164, SIZE5]],
      stretch: {
    ...
    0x2906: {
      dir: H,
      HW: [[0.926, GENERAL]],
      stretch: { left: [0x21d0, GENERAL], rep: [0x3d, GENERAL], right: [0x2ae4, GENERAL, 0, -0.09] }
    },
    // rightwards double arrow from bar
    0x2907: {
      dir: H,
      HW: [[0.926, GENERAL]],
      stretch: { left: [0x22a8, GENERAL, 0, -0.09], rep: [0x3d, GENERAL], right: [0x21d2, GENERAL] }
    },
    ...
    0x295a: {
      dir: H,
      HW: [[0.926, GENERAL]],
      stretch: { left: [0x21bc, GENERAL], rep: [0x2212, GENERAL], right: [0x22a3, BOLD, 0, 0.1, 0.6] }
    },
    ...
    0x295c: {
      dir: V,
      HW: [[0.818, GENERAL]],
      stretch: { bot: [0x5f, GENERAL, 0.05, -0.01, 0.8], ext: [0x23d0, GENERAL], top: [0x21be, GENERAL] }
    },
    // down harpoon with barb right from bar
    0x295d: {
      dir: V,
      HW: [[0.818, GENERAL]],
      stretch: { top: [0x22a4, BOLD, 0.04, 0, 0.6], ext: [0x23d0, GENERAL], bot: [0x21c2, GENERAL] }
    },
    // leftwards harpoon with barb down from bar
    0x295e: {
      dir: H,
      HW: [[0.926, GENERAL]],
      stretch: { left: [0x21bd, GENERAL], rep: [0x2212, GENERAL], right: [0x22a3, BOLD, 0, 0.1, 0.6] }
    },
    ...
    0x2960: {
      dir: V,
      HW: [[0.818, GENERAL]],
      stretch: { bot: [0x5f, GENERAL, 0.05, -0.01, 0.8], ext: [0x23d0, GENERAL], top: [0x21bf, GENERAL] }
    },
    // down harpoon with barb left from bar
    0x2961: {
      dir: V,
      HW: [[0.818, GENERAL]],
      stretch: { top: [0x22a4, BOLD, 0.04, 0, 0.6], ext: [0x23d0, GENERAL], bot: [0x21c3, GENERAL] }
    },

    // caron
    0x02c7: {
      dir: H,
      HW: [[0.333, GENERAL], [0.56, SIZE1], [0.979, SIZE2], [1.458, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
    },
    // low macron
    0x02cd: {
      dir: H,
    ...
    0x02f7: {
      dir: H,
      HW: [[0.558, SIZE1], [0.977, SIZE2], [1.458, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
    },
    ...
    0x21e0: {
      dir: H,
      HW: [[0.926, GENERAL]],
      stretch: { left: [0x21e0, GENERAL], rep: [0xe121, NONUNI, 0, 0, 0, 0, 0.1], fullExtenders: true }
    },
    // up dashed arrow
    0x21e1: {
      dir: V,
    ...
    0x21e2: {
      dir: H,
      HW: [[0.926, GENERAL]],
      stretch: { right: [0x21e2, VARIANT], rep: [0xe12e, NONUNI, 0, 0, 0, 0, 0.1], fullExtenders: true }
    },
    // down dashed arrow
    0x21e3: {
      dir: V,
    ...
    0x27e6: {
      dir: V,
      HW: [[0.93, GENERAL], [1.23, SIZE1], [1.845, SIZE2], [2.46, SIZE3], [3.075, SIZE4]],
    ...
    0x27ea: {
      dir: V,
      HW: [[0.931, GENERAL], [1.23, SIZE1], [1.845, SIZE2], [2.461, SIZE3], [3.075, SIZE4]]
    },
    ...
    0x2997: {
      dir: V,
      HW: [[0.932, GENERAL]],
      stretch: { top: [0xe10d, NONUNI, 0.1, 0.05], ext: [0x23d0, GENERAL, -0.1], bot: [0xe10c, NONUNI, 0.1] }
    },
    // right black tortoise shell
    0x2998: {
      dir: V,
      HW: [[0.932, GENERAL]],
      stretch: { top: [0xe10c, NONUNI, -0.1, 0.05], ext: [0x23d0, GENERAL], bot: [0xe10d, NONUNI, -0.1] }
    }
  };
