...
(function(HTMLCSS, MML, HTML) {
    ...
    FONTDATA: {
      ...
      VARIANT: {
        ...
        monospace: {
          offsetA: 0x1d670,
          offsetN: 0x1d7f6,
          remap: { 0x20: [0x20, "-STIX-variant"], 0xa0: [0xa0, "-STIX-variant"] }
      ...
      DELIMITERS: {
        ...
        0x02c6: {
          dir: H,
          HW: [[0.333, GENERAL], [0.56, SIZE1], [0.979, SIZE2], [1.46, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
        },
        // wide caron
        0x02c7: {
          dir: H,
        ...
        0x02dc: {
          dir: H,
          HW: [[0.333, GENERAL], [0.558, SIZE1], [0.978, SIZE2], [1.458, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
        },
        ...
        0x21d5: {
          dir: V,
          HW: [[0.818, GENERAL]],
          stretch: { top: [0x21d1, GENERAL], ext: [0x2225, GENERAL, 0.082], bot: [0x21d3, GENERAL] }
        },
        // \surd
        0x221a: {
          dir: V,
          HW: [[0.954, "STIXVariants"], [1.232, GENERAL], [1.847, SIZE1], [2.46, SIZE2], [3.075, SIZE3]],
        ...
        0x23d0: {
          dir: V,
          HW: [[0.304, GENERAL], [0.69, GENERAL, null, 0x7c], [0.879, GENERAL, null, 0x2223]],
          stretch: { ext: [0x2223, GENERAL] }
        },
        // horizontal brace down
        0x23de: {
          dir: H,
          HW: [[0.926, SIZE1], [1, GENERAL], [1.46, SIZE2], [1.886, SIZE3], [2.328, SIZE4], [3.238, SIZE5]],
  ...
  HTMLCSS.FONTDATA.FONTS["STIXIntegralsD"] = {
    ...
    Ranges: [[0x20, 0x20, "All"], [0xa0, 0xa0, "All"], [0x222b, 0x2233, "All"], [0x2a0b, 0x2a1c, "All"]],
  ...
  HTMLCSS.FONTDATA.FONTS["STIXNonUnicode"] = {
    ...
    Ranges: [[0x20, 0x20, "All"], [0xa0, 0xa0, "All"], [0xe000, 0xf8ff, "PrivateUse"]],
