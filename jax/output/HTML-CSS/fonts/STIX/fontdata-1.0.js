...
(function(HTMLCSS, HUB) {
  ...
  HTMLCSS.FONTDATA.DELIMITERS[0x23de].HW[0] = [0.556, "STIXGeneral"];
  HTMLCSS.FONTDATA.DELIMITERS[0x23de].HW[1] = [0.926, "STIXSizeOneSym"];
  HTMLCSS.FONTDATA.DELIMITERS[0x23df].HW[0] = [0.556, "STIXGeneral"];
  HTMLCSS.FONTDATA.DELIMITERS[0x23df].HW[1] = [0.926, "STIXSizeOneSym"];

  HUB.Register.LoadHook(HTMLCSS.fontDir + "/fontdata-extra.js", function() {
    HTMLCSS.FONTDATA.DELIMITERS[0x23dc].HW[0] = [0.556, "STIXGeneral"];
    HTMLCSS.FONTDATA.DELIMITERS[0x23dc].HW[1] = [0.926, "STIXSizeOneSym"];
    HTMLCSS.FONTDATA.DELIMITERS[0x23dd].HW[0] = [0.556, "STIXGeneral"];
    HTMLCSS.FONTDATA.DELIMITERS[0x23dd].HW[1] = [0.926, "STIXSizeOneSym"];
    HTMLCSS.FONTDATA.DELIMITERS[0x23e0].HW[0][0] = 0.926;
    HTMLCSS.FONTDATA.DELIMITERS[0x23e1].HW[0][0] = 0.926;
  });
