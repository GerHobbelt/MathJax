    ...
    MathJax.Hub.Browser.Select({
      MSIE: function(browser) {
        if (HTMLCSS.config.availableFonts && HTMLCSS.config.availableFonts.length) {
          ...
          if (
            HTMLCSS.Font.testFont({ family: "MathJax_Greek", weight: "bold", style: "italic", testString: testString })
          ) {
            HTMLCSS.Augment({
              FONTDATA: {
                VARIANT: {
          ...
          HTMLCSS.Augment({
            FONTDATA: {
              ...
              DELIMITERS: {
                ...
                0x2190: { HW: { 0: [0.889, WinIE6, null, 0xe200] }, stretch: { left: [0xe200, WinIE6] } },
                0x2191: {
                  HW: { 0: [0.888, WinIE6, null, 0xe201] },
                  stretch: { top: [0xe287, WinIE6], ext: [0xe289, WinIE6] }
                },
                0x2192: { HW: { 0: [0.889, WinIE6, null, 0xe202] }, stretch: { right: [0xe202, WinIE6] } },
                0x2193: {
