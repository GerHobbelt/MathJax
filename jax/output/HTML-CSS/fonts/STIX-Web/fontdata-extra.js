...
(function(HTMLCSS) {
  ...
  var delim = {
    ...
    0x2c7: {
      dir: H,
      HW: [[0.311, MAIN], [0.56, SIZE1], [0.979, SIZE2], [1.46, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
    },
    0x2cd: {
      dir: H,
      HW: [[0.312, MARKS]],
    ...
    0x2f7: {
      dir: H,
      HW: [[0.33, MARKS], [0.56, SIZE1], [0.979, SIZE2], [1.46, SIZE3], [1.886, SIZE4], [2.328, SIZE5]]
    },
    0x20d0: {
      dir: H,
      HW: [[0.436, MARKS], [0.871, SIZE1], [1.308, SIZE2], [1.744, SIZE3], [2.18, SIZE4], [3.0, SIZE5]],
    ...
    0x20d6: {
      dir: H,
      HW: [[0.436, MARKS], [0.872, SIZE1], [1.308, SIZE2], [1.744, SIZE3], [2.18, SIZE4], [3.0, SIZE5]],
    ...
    0x21a5: {
      dir: V,
      HW: [[0.816, ARROWS]],
      stretch: { bot: [0x5f, MAIN, 0.05, -0.01, 0.8], ext: [0x23d0, MAIN], top: [0x2191, MAIN] }
    },
    0x21a6: {
      dir: H,
      HW: [[0.787, MAIN]],
    ...
    0x21a7: {
      dir: V,
      HW: [[0.816, ARROWS]],
      stretch: { top: [0x22a4, MAINBOLD, 0.04, 0.0, 0.6], ext: [0x23d0, MAIN], bot: [0x2193, MAIN] }
    },
    0x21a8: {
      dir: V,
      HW: [[0.816, ARROWS]],
    ...
    0x23dc: {
      dir: H,
      HW: [[1.0, MAIN], [0.926, SIZE1], [1.46, SIZE2], [1.886, SIZE3], [2.328, SIZE4], [3.237, SIZE5]],
    ...
    0x23e0: {
      dir: H,
      HW: [[1.0, MAIN], [1.46, SIZE1], [1.886, SIZE2], [2.312, SIZE3], [2.738, SIZE4], [3.164, SIZE5]]
    },
    0x23e1: {
      dir: H,
      HW: [[1.0, MAIN], [1.46, SIZE1], [1.886, SIZE2], [2.312, SIZE3], [2.738, SIZE4], [3.164, SIZE5]]
    ...
    0x2772: {
      dir: V,
      HW: [[0.932, MISC], [1.23, SIZE1], [1.845, SIZE2], [2.459, SIZE3], [3.075, SIZE4]]
    },
    0x2773: {
      dir: V,
      HW: [[0.932, MISC], [1.23, SIZE1], [1.845, SIZE2], [2.459, SIZE3], [3.075, SIZE4]]
    ...
    0x27e6: {
      dir: V,
      HW: [[0.93, SYMBOLS], [1.23, SIZE1], [1.845, SIZE2], [2.46, SIZE3], [3.075, SIZE4]],
    ...
    0x27ea: {
      dir: V,
      HW: [[0.932, SYMBOLS], [1.23, SIZE1], [1.845, SIZE2], [2.461, SIZE3], [3.075, SIZE4]]
    },
    0x27eb: {
      dir: V,
      HW: [[0.932, SYMBOLS], [1.23, SIZE1], [1.845, SIZE2], [2.461, SIZE3], [3.075, SIZE4]]
    ...
    0x2906: {
      dir: H,
      HW: [[0.816, ARROWS]],
      stretch: { left: [0x21d0, MAIN], rep: [0x3d, MAIN], right: [0x2ae4, OPERATORS, 0.0, -0.09] }
    },
    0x2907: {
      dir: H,
      HW: [[0.816, ARROWS]],
      stretch: { left: [0x22a8, MAIN, 0.0, -0.09], rep: [0x3d, MAIN], right: [0x21d2, MAIN] }
    },
    0x290a: {
      dir: V,
      HW: [[0.818, ARROWS]],
    ...
    0x295a: {
      dir: H,
      HW: [[0.816, ARROWS]],
      stretch: { left: [0x21bc, MAIN], rep: ARROWREP, right: [0x22a3, MAINBOLD, 0.0, 0.1, 0.6] }
    },
    0x295b: {
      dir: H,
      HW: [[0.816, ARROWS]],
    ...
    0x295c: {
      dir: V,
      HW: [[0.818, ARROWS]],
      stretch: { bot: [0x5f, MAIN, 0.05, -0.01, 0.8], ext: [0x23d0, MAIN], top: [0x21be, MAIN] }
    },
    0x295d: {
      dir: V,
      HW: [[0.818, ARROWS]],
      stretch: { top: [0x22a4, MAINBOLD, 0.04, 0.0, 0.6], ext: [0x23d0, MAIN], bot: [0x21c2, MAIN] }
    },
    0x295e: {
      dir: H,
      HW: [[0.816, ARROWS]],
      stretch: { left: [0x21bd, MAIN], rep: ARROWREP, right: [0x22a3, MAINBOLD, 0.0, 0.1, 0.6] }
    },
    0x295f: {
      dir: H,
      HW: [[0.816, ARROWS]],
    ...
    0x2960: {
      dir: V,
      HW: [[0.818, ARROWS]],
      stretch: { bot: [0x5f, MAIN, 0.05, -0.01, 0.8], ext: [0x23d0, MAIN], top: [0x21bf, MAIN] }
    },
    0x2961: {
      dir: V,
      HW: [[0.818, ARROWS]],
      stretch: { top: [0x22a4, MAINBOLD, 0.04, 0.0, 0.6], ext: [0x23d0, MAIN], bot: [0x21c3, MAIN] }
    },
    0x2980: {
      dir: V,
      HW: [[0.884, SYMBOLS]],
    ...
    0x2983: {
      dir: V,
      HW: [[0.932, SYMBOLS], [1.23, SIZE1], [1.845, SIZE2], [2.46, SIZE3], [3.075, SIZE4]]
    },
    0x2984: {
      dir: V,
      HW: [[0.932, SYMBOLS], [1.23, SIZE1], [1.845, SIZE2], [2.46, SIZE3], [3.075, SIZE4]]
    ...
    0x2985: {
      dir: V,
      HW: [[0.932, SYMBOLS], [1.23, SIZE1], [1.848, SIZE2], [2.459, SIZE3], [3.075, SIZE4]]
    },
    0x2986: {
      dir: V,
      HW: [[0.932, SYMBOLS], [1.23, SIZE1], [1.848, SIZE2], [2.459, SIZE3], [3.075, SIZE4]]
    ...
    0x2997: {
      dir: V,
      HW: [[0.932, MAIN]],
      stretch: { top: [0xe10d, SHAPES, 0.1, 0.05], ext: [0x23d0, MAIN, -0.1], bot: [0xe10c, SHAPES, 0.1] }
    },
    0x2998: {
      dir: V,
      HW: [[0.932, MAIN]],
      stretch: { top: [0xe10c, SHAPES, -0.1, 0.05], ext: [0x23d0, MAIN], bot: [0xe10d, SHAPES, -0.1] }
    },
    0x2a00: {
      dir: V,
      HW: [[1.022, OPERATORS], [1.451, SIZE1]]
