/*
 *  ../../../..//jax/output/HTML-CSS/fonts/Asana-Math/fontdata.js
 *
  ...
  HTMLCSS.Augment({
    FONTDATA: {
      ...
      DELIMITERS: {
        ...
        0x5b: {
          dir: V,
          HW: [[0.91, MAIN], [1.476, SIZE1], [2.045, SIZE2], [2.556, SIZE3], [2.615, SIZE3, 1.023]],
          stretch: { bot: [0x23a3, SYMBOLS], ext: [0x23a2, SYMBOLS], top: [0x23a1, SYMBOLS] }
        },
        0x5c: {
          dir: V,
          HW: [[0.883, MAIN], [1.27, MAIN, 1.439], [1.719, MAIN, 1.946], [2.167, MAIN, 2.454], [2.615, MAIN, 2.961]]
        },
        0x5d: {
          dir: V,
          HW: [[0.91, MAIN], [1.476, SIZE1], [2.045, SIZE2], [2.556, SIZE3], [2.615, SIZE3, 1.023]],
        ...
        0x303: {
          dir: H,
          HW: [[0.33, MAIN], [0.701, SIZE1], [1.053, SIZE2], [1.403, SIZE3], [1.865, SIZE4], [2.797, SIZE5]]
        },
        0x305: {
          dir: H,
        ...
        0x30c: {
          dir: H,
          HW: [[0.312, MAIN], [0.737, SIZE1], [1.105, SIZE2], [1.474, SIZE3], [1.96, SIZE4], [2.94, SIZE5]]
        },
        0x332: {
          dir: H,
          HW: [[0.433, MARKS], [0.511, SIZE1], [0.675, SIZE2], [1.127, SIZE3]],
        ...
        0x221a: {
          dir: V,
          HW: [[1.138, MAIN], [1.28, SIZE1], [1.912, SIZE2], [2.543, SIZE3], [3.175, SIZE4]],
        ...
        0x2308: {
          dir: V,
          HW: [[0.885, MAIN], [1.47, SIZE1], [2.041, SIZE2], [2.552, SIZE3], [2.615, SIZE3, 1.025]],
        ...
        0x23d0: {
          dir: V,
          HW: [
            [0.885, MAIN, null, 0x7c],
            [1.27, MAIN, 1.435, 0x7c],
            [1.719, MAIN, 1.942, 0x7c],
            [2.167, MAIN, 2.448, 0x7c],
            [2.615, MAIN, 2.955, 0x7c]
          ],
        ...
        0x27c5: {
          dir: V,
          HW: [[0.91, SYMBOLS], [1.021, SIZE1], [1.531, SIZE2], [2.041, SIZE3], [2.552, SIZE4], [3.063, SIZE5]]
        },
        0x27c6: {
          dir: V,
          HW: [[0.91, SYMBOLS], [1.021, SIZE1], [1.531, SIZE2], [2.041, SIZE3], [2.552, SIZE4], [3.063, SIZE5]]
