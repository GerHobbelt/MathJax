  ...
  MML.maction.Augment({
    ...
    HTMLsetStatus: function(event) {
      ...
      this.messageID = MathJax.Message.Set(
        this.data[1] && this.data[1].isToken ? this.data[1].data.join("") : this.data[1].toString()
      );
    },
    ...
    HTMLtooltipPost: function(x, y) {
      ...
      var scale = Math.floor(
        Math.max(HTMLCSS.config.minScaleAdjust / 100, ex / HTMLCSS.TeX.x_height / em) * HTMLCSS.config.scale
      );
