            ...
            if (HTMLCSS.useVML) {
              ...
              this.HTMLvmlElement(vml, "shape", {
                style: {
                  ...
                  left: this.HTMLpx(t, 0.5),
                  top: this.HTMLpx(t, 0.5)
                },
                path:
                  "m " +
                  r +
          ...
          case MML.NOTATION.UPDIAGONALARROW:
            if (HTMLCSS.useVML) {
              ...
              this.HTMLsvgElement(svg.firstChild, "line", {
                x1: 1,
                y1: this.HTMLpx(H + D - t),
                x2: this.HTMLpx(x - 0.7 * w),
                y2: this.HTMLpx(y + 0.7 * h)
              });
              this.HTMLsvgElement(svg.firstChild, "polygon", {
                points:
                  ...
                  this.HTMLpx(y) +
                  " " +
                  this.HTMLpx(x - w - 0.4 * h) +
                  "," +
                  this.HTMLpx(y + h - 0.4 * w) +
                  " " +
                  this.HTMLpx(x - 0.7 * w) +
                  "," +
                  this.HTMLpx(y + 0.7 * h) +
          ...
          case MML.NOTATION.PHASORANGLE:
            ...
            if (HTMLCSS.useVML) {
              ...
              this.HTMLvmlElement(vml, "shape", {
                ...
                path:
                  "m " +
                  this.HTMLpt(p + t / 2, t / 2) +
                  " l " +
                  this.HTMLpt(t / 2, H + D - t) +
                  " " +
                  this.HTMLpt(W - t / 2, H + D - t) +
                  " e",
