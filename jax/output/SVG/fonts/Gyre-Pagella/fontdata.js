/*
 *  ../../../..//jax/output/SVG/fonts/Gyre-Pagella/fontdata.js
 *
...
(function(SVG, MML, AJAX, HUB) {
    ...
    FONTDATA: {
      ...
      DELIMITERS: {
        ...
        0x23d0: {
          ...
          HW: [
            [800, MAIN, null, 0x7c],
            [1269, MAIN, 1.586, 0x7c],
            [1717, MAIN, 2.146, 0x7c],
            [2164, MAIN, 2.705, 0x7c],
            [2612, MAIN, 3.265, 0x7c]
          ],
  ...
  MathJax.Hub.Register.LoadHook(SVG.fontDir + "/Size1/Regular/Main.js", function() {
    var i;
    for (i = 0x222b; i <= 0x222d; i++) SVG.FONTDATA.FONTS[SIZE1][i][2] -= 190;
    for (i = 0x222e; i <= 0x2231; i++) SVG.FONTDATA.FONTS[SIZE1][i][2] -= 100;
  });
