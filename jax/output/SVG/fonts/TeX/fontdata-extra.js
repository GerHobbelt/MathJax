...
(function(SVG) {
  ...
  var H = "H",
    V = "V";
  var ARROWREP = [0x2212, MAIN, 0, 0, 0, -0.31, -0.31]; // add depth for arrow extender
  ...
  var delim = {
    ...
    0x21a4: {
      dir: H,
      HW: [],
      stretch: { min: 1, left: [0x2190, MAIN], rep: ARROWREP, right: [0x2223, SIZE1, 0, -0.05, 0.9] }
    },
    // up arrow from bar
    0x21a5: {
      dir: V,
      HW: [],
      stretch: { min: 0.6, bot: [0x22a5, BOLD, 0, 0, 0.75], ext: [0x23d0, SIZE1], top: [0x2191, SIZE1] }
    },
    // right arrow from bar
    0x21a6: {
      dir: H,
      HW: [[1000, MAIN]],
      stretch: { left: [0x2223, SIZE1, -0.09, -0.05, 0.9], rep: ARROWREP, right: [0x2192, MAIN] }
    },
    // down arrow from bar
    0x21a7: {
      dir: V,
      HW: [],
      stretch: { min: 0.6, top: [0x22a4, BOLD, 0, 0, 0.75], ext: [0x23d0, SIZE1], bot: [0x2193, SIZE1] }
    },
    ...
    0x23b4: {
      dir: H,
      HW: [],
      stretch: { min: 0.5, left: [0x250c, AMS, 0, -0.1], rep: [0x2212, MAIN, 0, 0.325], right: [0x2510, AMS, 0, -0.1] }
    },
    ...
    0x23dc: {
      dir: H,
      HW: [[778, AMS, 0, 0x2322], [100, MAIN, 0, 0x2322]],
      stretch: { left: [0xe150, SIZE4], rep: [0xe154, SIZE4], right: [0xe151, SIZE4] }
    },
    // bottom paren
    0x23dd: {
      dir: H,
      HW: [[778, AMS, 0, 0x2323], [100, MAIN, 0, 0x2323]],
    ...
    0x2906: {
      dir: H,
      HW: [],
      stretch: { min: 1, left: [0x21d0, MAIN], rep: DARROWREP, right: [0x2223, SIZE1, 0, -0.1] }
    },
    // rightwards double arrow from bar
    0x2907: {
      dir: H,
      HW: [],
      stretch: { min: 0.7, left: [0x22a8, AMS, 0, -0.12], rep: DARROWREP, right: [0x21d2, MAIN] }
    },
    // left barb up right barb up harpoon
    0x294e: {
      dir: H,
      HW: [],
      stretch: { min: 0.5, left: [0x21bc, MAIN], rep: ARROWREP, right: [0x21c0, MAIN] }
    },
    // up barb right down barb right harpoon
    0x294f: {
      dir: V,
      HW: [],
      stretch: { min: 0.5, top: [0x21be, AMS, 0.12, 0, 1.1], ext: [0x23d0, SIZE1], bot: [0x21c2, AMS, 0.12, 0, 1.1] }
    },
    // left barb dow right barb down harpoon
    0x2950: {
      dir: H,
      HW: [],
      stretch: { min: 0.5, left: [0x21bd, MAIN], rep: ARROWREP, right: [0x21c1, MAIN] }
    },
    // up barb left down barb left harpoon
    0x2951: {
      dir: V,
      HW: [],
      stretch: { min: 0.5, top: [0x21bf, AMS, 0.12, 0, 1.1], ext: [0x23d0, SIZE1], bot: [0x21c3, AMS, 0.12, 0, 1.1] }
    },
    // leftwards harpoon with barb up from bar
    0x295a: {
      dir: H,
      HW: [],
      stretch: { min: 1, left: [0x21bc, MAIN], rep: ARROWREP, right: [0x2223, SIZE1, 0, -0.05, 0.9] }
    },
    // rightwards harpoon with barb up from bar
    0x295b: {
      dir: H,
      HW: [],
      stretch: { min: 1, left: [0x2223, SIZE1, -0.05, -0.05, 0.9], rep: ARROWREP, right: [0x21c0, MAIN] }
    },
    // up harpoon with barb right from bar
    0x295c: {
      dir: V,
      HW: [],
      stretch: { min: 0.7, bot: [0x22a5, BOLD, 0, 0, 0.75], ext: [0x23d0, SIZE1], top: [0x21be, AMS, 0.12, 0, 1.1] }
    },
    // down harpoon with barb right from bar
    0x295d: {
      dir: V,
      HW: [],
      stretch: { min: 0.7, top: [0x22a4, BOLD, 0, 0, 0.75], ext: [0x23d0, SIZE1], bot: [0x21c2, AMS, 0.12, 0, 1.1] }
    },
    // leftwards harpoon with barb down from bar
    0x295e: {
      dir: H,
      HW: [],
      stretch: { min: 1, left: [0x21bd, MAIN], rep: ARROWREP, right: [0x2223, SIZE1, 0, -0.05, 0.9] }
    },
    // rightwards harpoon with barb down from bar
    0x295f: {
      dir: H,
      HW: [],
      stretch: { min: 1, left: [0x2223, SIZE1, -0.05, -0.05, 0.9], rep: ARROWREP, right: [0x21c1, MAIN] }
    },
    // up harpoon with barb left from bar
    0x2960: {
      dir: V,
      HW: [],
      stretch: { min: 0.7, bot: [0x22a5, BOLD, 0, 0, 0.75], ext: [0x23d0, SIZE1], top: [0x21bf, AMS, 0.12, 0, 1.1] }
    },
    // down harpoon with barb left from bar
    0x2961: {
      dir: V,
      HW: [],
      stretch: { min: 0.7, top: [0x22a4, BOLD, 0, 0, 0.75], ext: [0x23d0, SIZE1], bot: [0x21c3, AMS, 0.12, 0, 1.1] }
    }
  };
