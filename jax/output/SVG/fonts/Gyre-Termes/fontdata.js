/*
 *  ../../../..//jax/output/SVG/fonts/Gyre-Termes/fontdata.js
 *
...
(function(SVG, MML, AJAX, HUB) {
  ...
  SVG.Augment({
    FONTDATA: {
      ...
      DELIMITERS: {
        ...
        0x2212: {
          HW: [],
          stretch: { rep: [0x2212, MAIN, 0, 0, 0, -0.224, -0.224] }
        },
        ...
        0x23d0: {
          ...
          HW: [
            [800, MAIN, null, 0x7c],
            [1350, MAIN, 1.688, 0x7c],
            [1827, MAIN, 2.283, 0x7c],
            [2303, MAIN, 2.879, 0x7c],
            [2780, MAIN, 3.474, 0x7c]
          ],
  ...
  MathJax.Hub.Register.LoadHook(SVG.fontDir + "/Size1/Regular/Main.js", function() {
    var i;
    for (i = 0x222b; i <= 0x222d; i++) SVG.FONTDATA.FONTS[SIZE1][i][2] -= 200;
    for (i = 0x222e; i <= 0x2231; i++) SVG.FONTDATA.FONTS[SIZE1][i][2] -= 150;
  });
