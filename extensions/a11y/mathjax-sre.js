  ...
  (goog.Es6ModuleDependency.prototype.load = function(a) {
    function b(a, b) {
      b
        ...
        : d.write('<script type="module" crossorigin src="' + a + '">\x3c/script>');
    }
    function c(a, b) {
...
sre.SystemExternal.require = function(a) {
  return "undefined" !== typeof process && "undefined" !== typeof require ? require(a) : null;
};
sre.SystemExternal.documentSupported = function() {
  return "undefined" != typeof document;
};
sre.SystemExternal.process = sre.SystemExternal.require("process");
sre.SystemExternal.xmldom = sre.SystemExternal.documentSupported() ? window : sre.SystemExternal.require("xmldom-sre");
...
sre.SystemExternal.jsonPath = (function() {
  return (
    (sre.SystemExternal.process && "undefined" !== typeof global
      ? sre.SystemExternal.process.env.SRE_JSON_PATH || global.SRE_JSON_PATH || sre.SystemExternal.process.cwd()
...
sre.BrowserUtil.detectIE = function() {
  if (!("undefined" !== typeof window && "ActiveXObject" in window && "clipboardData" in window)) return !1;
...
sre.BrowserUtil.installWGXpath_ = function(a, b) {
  ...
  "undefined" === typeof wgxpath && 10 > c
    ...
    : 10 <= c ||
      ...
      a ? sre.SystemExternal.wgxpath.install({ document: document }) : sre.SystemExternal.wgxpath.install(),
...
sre.DynamicCstr.DEFAULT_VALUES[sre.DynamicCstr.Axis.DOMAIN] = sre.DynamicCstr.DEFAULT_VALUE;
...
sre.DynamicCstr.Parser.prototype.parse = function(a) {
  a = a.split(".");
  var b = {};
  if (a.length > this.order_.length) throw Error("Invalid dynamic constraint: " + b);
...
sre.DynamicCstr.DefaultComparator = function(a, b) {
  this.reference_ = a;
  this.fallback_ = b || new sre.DynamicProperties(a.getProperties(), a.getOrder());
...
sre.DynamicCstr.DefaultComparator.prototype.match = function(a) {
  ...
  return (
    ...
    b.every(
      goog.bind(function(b) {
        var c = a.getValue(b);
        return c === this.reference_.getValue(b) || -1 !== this.fallback_.getProperty(b).indexOf(c);
      }, this)
    )
  );
};
...
sre.AudioUtil.personalityMarkup = function(a) {
  ...
  for (var b = [], c = {}, d = 0, e; (e = a[d]); d++) {
    ...
    void 0 !== e[sre.Engine.personalityProps.PAUSE] &&
      ((f = {}),
      (f[sre.Engine.personalityProps.PAUSE] = e[sre.Engine.personalityProps.PAUSE]),
...
sre.AudioUtil.isPauseElement = function(a) {
  return (
    "object" === typeof a && 1 === Object.keys(a).length && Object.keys(a)[0] === sre.Engine.personalityProps.PAUSE
  );
};
sre.AudioUtil.isStringElement = function(a) {
  return "object" === typeof a && 1 === Object.keys(a).length && "string" === Object.keys(a)[0];
};
sre.AudioUtil.appendMarkup_ = function(a, b, c, d, e) {
  if (e) {
    ...
    e && b && 0 === Object.keys(c).length && sre.AudioUtil.isStringElement(e) && ((e.string += " " + b), (b = ""));
  }
  ...
  if (sre.AudioUtil.isMarkupElement(c)) {
    for (a = c.close.slice(); 0 < a.length; ) {
      ...
      if (0 === a.length) 0 !== h.length && sre.AudioUtil.LastOpen_.push(h);
        ...
        for (c.close = c.close.concat(h), c.open = c.open.concat(h), d = 0; (e = h[d]); d++) c[e] = b[e];
    }
...
sre.AcssRenderer.prototype.markup = function(a) {
  ...
  for (var b = [], c = { open: [] }, d = null, e = !1, f = 0, g; (g = a[f]); f++)
    ...
    else if (sre.AudioUtil.isPauseElement(g)) e && (d = sre.AudioUtil.mergePause(d, g, Math.max));
    else {
      g = '"' + g.string + '"';
      e = !0;
...
sre.AcssRenderer.prototype.prosody_ = function(a) {
  for (var b = a.open, c = [], d = 0, e; (e = b[d]); d++) c.push(this.prosodyElement(e, a[e]));
  return c.join(" ");
};
    ...
    if (e.string) b.push(e.string);
      ...
      if (e.close.length)
        for (var f = 0; f < e.close.length; f++) {
          var g = c.pop();
          if (-1 === e.close.indexOf(g)) throw Error("Unknown closing markup element: " + g);
...
sre.SsmlRenderer.prototype.prosodyElement = function(a, b) {
  b = this.applyScaleFunction(b);
  b = 0 > b ? b.toString() : "+" + b;
  return "<PROSODY " + a.toUpperCase() + '="' + b + (a === sre.Engine.personalityProps.VOLUME ? ">" : '%">');
};
...
sre.BaseUtil.interleaveLists = function(a, b) {
  for (var c = []; a.length || b.length; ) a.length && c.push(a.shift()), b.length && c.push(b.shift());
  return c;
};
...
sre.AuralRendering.registerRenderer(sre.Engine.Markup.ACSS, new sre.AcssRenderer());
sre.AuralRendering.registerRenderer(sre.Engine.Markup.SABLE, new sre.SableRenderer());
sre.AuralRendering.xmlInstance = new sre.SsmlRenderer();
sre.AuralRendering.registerRenderer(sre.Engine.Markup.VOICEXML, sre.AuralRendering.xmlInstance);
sre.AuralRendering.registerRenderer(sre.Engine.Markup.SSML, sre.AuralRendering.xmlInstance);
...
sre.XpathUtil.evaluateXpath_ = function(a, b, c) {
  ...
  return d.mode !== sre.Engine.Mode.HTTP || d.isIE || d.isEdge
    ...
    : sre.XpathUtil.currentDocument.evaluate(a, b, sre.XpathUtil.resolveNameSpace, c, null);
};
...
sre.DomUtil.parseInput = function(a, b) {
  ...
  try {
    ...
    return sre.Engine.getInstance().mode === sre.Engine.Mode.HTTP
      ? ((sre.XpathUtil.currentDocument = e), d ? e.body.childNodes[0] : e.documentElement)
      : e.documentElement;
  } catch (f) {
...
sre.EnrichCaseFactory.getCase = function(a) {
  for (var b = 0, c; (c = sre.EnrichCaseFactory.cases[b]); b++) if (c.test(a)) return new c.constr(a);
  return null;
};
...
sre.SemanticUtil.hasIgnoreTag = function(a) {
  return !!a && -1 !== sre.SemanticUtil.IGNORETAGS.indexOf(sre.DomUtil.tagName(a));
};
sre.SemanticUtil.hasEmptyTag = function(a) {
  return !!a && -1 !== sre.SemanticUtil.EMPTYTAGS.indexOf(sre.DomUtil.tagName(a));
};
sre.SemanticUtil.purgeNodes = function(a) {
  for (var b = [], c = 0, d; (d = a[c]); c++) {
    var e = sre.DomUtil.tagName(d);
    -1 != sre.SemanticUtil.IGNORETAGS.indexOf(e) ||
      (-1 != sre.SemanticUtil.EMPTYTAGS.indexOf(e) && 0 == d.childNodes.length) ||
      b.push(d);
  }
  return b;
};
...
sre.SemanticAttr = function() {
  ...
  this.allFences = this.neutralFences.concat(this.leftFences, this.rightFences, this.topFences, this.bottomFences);
...
sre.SemanticAttr.isMatchingFenceRole = function(a, b) {
  return (
    ...
    (a == sre.SemanticAttr.Role.NEUTRAL && b == sre.SemanticAttr.Role.NEUTRAL) ||
...
sre.MathUtil.isMathNodeOfClass_ = function(a, b) {
  return (
    ...
    (sre.MathUtil.isMathmlNodeOfClass_(a, b) || sre.MathUtil.isMathjaxNodeOfClass_(a, b))
  );
};
...
sre.SemanticNode.prototype.querySelectorAll = function(a) {
  for (var b = [], c = 0, d; (d = this.childNodes[c]); c++) b = b.concat(d.querySelectorAll(a));
...
sre.SemanticNode.prototype.toString = function(a) {
  var b = new sre.SystemExternal.xmldom.XMLSerializer(),
    c = new sre.SystemExternal.xmldom.DOMParser().parseFromString("", "text/xml");
...
sre.SemanticNode.prototype.addMathmlNodes = function(a) {
  for (var b = 0, c; (c = a[b]); b++) -1 == this.mathml.indexOf(c) && this.mathml.push(c);
};
sre.SemanticNode.prototype.removeMathmlNodes_ = function(a) {
  for (var b = this.mathml, c = 0, d; (d = a[c]); c++) (d = b.indexOf(d)), -1 != d && b.splice(d, 1);
  this.mathml = b;
};
...
sre.SemanticNode.prototype.appendContentNode = function(a) {
  a && (this.contentNodes.push(a), this.addMathmlNodes(a.mathml), (a.parent = this));
};
...
sre.SemanticNode.prototype.equals = function(a) {
  if (
    ...
    return !1;
  for (var b = 0, c, d; (c = this.childNodes[b]), (d = a.childNodes[b]); b++) if (!c.equals(d)) return !1;
  for (b = 0; (c = this.contentNodes[b]), (d = a.contentNodes[b]); b++) if (!c.equals(d)) return !1;
  return !0;
};
...
sre.SemanticPred.isAccent = function(a) {
  return (
    ...
    (sre.SemanticPred.isAttribute("type", "IDENTIFIER")(a) &&
      ...
      !a.textContent.match(new RegExp(sre.SemanticAttr.getInstance().allLetters.join("|"))))
  );
};
sre.SemanticPred.isSimpleFunction = function(a) {
  ...
  return a.type !== sre.SemanticAttr.Type.INFIXOP ||
    (a.role === sre.SemanticAttr.Role.IMPLICIT && !a.childNodes.some(sre.SemanticPred.isAttribute("type", "INFIXOP")))
    ? !0
    : !1;
};
sre.SemanticPred.isPrefixFunctionBoundary = function(a) {
  return sre.SemanticPred.isOperator(a) || sre.SemanticPred.isGeneralFunctionBoundary(a);
};
sre.SemanticPred.isIntegralDxBoundary = function(a, b) {
  return !!b && sre.SemanticPred.isAttribute("type", "IDENTIFIER")(b) && sre.SemanticAttr.isCharacterD(a.textContent);
};
...
sre.SemanticPred.isOperator = function(a) {
  return (
    sre.SemanticPred.isAttribute("type", "OPERATOR")(a) || sre.SemanticPred.isAttribute("embellished", "OPERATOR")(a)
  );
};
sre.SemanticPred.isRelation = function(a) {
  return (
    sre.SemanticPred.isAttribute("type", "RELATION")(a) || sre.SemanticPred.isAttribute("embellished", "RELATION")(a)
  );
};
...
sre.SemanticPred.isFence = function(a) {
  return sre.SemanticPred.isAttribute("type", "FENCE")(a) || sre.SemanticPred.isAttribute("embellished", "FENCE")(a);
};
  ...
  var b = function(a) {
    return a.embellished
      ? !(
        ...
        (sre.SemanticPred.isAttribute("role", "CLOSE")(a) && sre.SemanticPred.isAttribute("type", "TENSOR")(a)) ||
...
sre.SemanticPred.isTableOrMultiline = function(a) {
  return (
    !!a && (sre.SemanticPred.isAttribute("type", "TABLE")(a) || sre.SemanticPred.isAttribute("type", "MULTILINE")(a))
  );
};
sre.SemanticPred.tableIsMatrixOrVector = function(a) {
  return (
    ...
    (sre.SemanticPred.isAttribute("role", "LEFTRIGHT")(a) || sre.SemanticPred.isAttribute("role", "NEUTRAL")(a)) &&
    1 === a.childNodes.length &&
    sre.SemanticPred.isTableOrMultiline(a.childNodes[0])
  );
};
sre.SemanticPred.tableIsCases = function(a, b) {
  return 0 < b.length && sre.SemanticPred.isAttribute("role", "OPENFENCE")(b[b.length - 1]);
};
...
sre.SemanticPred.isLimitBase = function(a) {
  return (
    ...
    (sre.SemanticPred.isAttribute("type", "FUNCTION")(a) && sre.SemanticPred.isAttribute("role", "LIMFUNC")(a))
  );
};
...
sre.SemanticPred.singlePunctAtPosition = function(a, b, c) {
  return 1 === b.length && a[c].type === sre.SemanticAttr.Type.PUNCTUATION && a[c] === b[0];
};
...
sre.SemanticProcessor.prototype.identifierNode = function(a, b, c) {
  ...
  if ("MathML-Unit" === c) (a.type = sre.SemanticAttr.Type.IDENTIFIER), (a.role = sre.SemanticAttr.Role.UNIT);
  else if (
    !b &&
  ...
  a.type === sre.SemanticAttr.Type.UNKNOWN && (a.type = sre.SemanticAttr.Type.IDENTIFIER);
...
sre.SemanticProcessor.prototype.prefixNode_ = function(a, b) {
  b = sre.SemanticProcessor.partitionNodes_(b, sre.SemanticPred.isAttribute("role", "SUBTRACTION"));
  for (
    a = sre.SemanticProcessor.getInstance().concatNode_(a, b.comp.pop(), sre.SemanticAttr.Type.PREFIXOP);
    0 < b.rel.length;

  )
    (a = sre.SemanticProcessor.getInstance().concatNode_(a, [b.rel.pop()], sre.SemanticAttr.Type.PREFIXOP)),
      (a.role = sre.SemanticAttr.Role.NEGATIVE),
      (a = sre.SemanticProcessor.getInstance().concatNode_(a, b.comp.pop(), sre.SemanticAttr.Type.PREFIXOP));
  return a;
};
sre.SemanticProcessor.prototype.postfixNode_ = function(a, b) {
  return b.length ? sre.SemanticProcessor.getInstance().concatNode_(a, b, sre.SemanticAttr.Type.POSTFIXOP) : a;
};
...
sre.SemanticProcessor.prototype.row = function(a) {
  ...
  if (0 === a.length) return sre.SemanticProcessor.getInstance().factory_.makeEmptyNode();
...
sre.SemanticProcessor.prototype.combineUnits_ = function(a) {
  ...
  do {
    ...
    if (1 < c.length) {
      var e = sre.SemanticProcessor.getInstance().factory_.makeContentNode(sre.SemanticAttr.invisibleTimes());
...
sre.SemanticProcessor.prototype.getMixedNumbers_ = function(a) {
  var b = sre.SemanticProcessor.partitionNodes_(a, function(a) {
    return sre.SemanticPred.isAttribute("type", "FRACTION")(a) && sre.SemanticPred.isAttribute("role", "VULGAR")(a);
  });
  ...
  for (var c = 0, d; (d = b.rel[c]); c++) {
    ...
    sre.SemanticPred.isAttribute("role", "INTEGER")(e[f])
      ? ((d = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.NUMBER, [e[f], d], [])),
...
sre.SemanticProcessor.prototype.getTextInRow_ = function(a) {
  if (1 >= a.length) return a;
  var b = sre.SemanticProcessor.partitionNodes_(a, sre.SemanticPred.isAttribute("type", "TEXT"));
  if (0 === b.rel.length) return a;
  a = [];
  var c = b.comp[0];
  0 < c.length && a.push(sre.SemanticProcessor.getInstance().row(c));
  for (var d = 0; (c = b.rel[d]); d++)
    a.push(c), (c = b.comp[d + 1]), 0 < c.length && a.push(sre.SemanticProcessor.getInstance().row(c));
...
sre.SemanticProcessor.prototype.relationsInRow_ = function(a) {
  ...
  if (1 === a.length) return a[0];
  a = b.comp.map(goog.bind(sre.SemanticProcessor.getInstance().operationsInRow_, this));
  if (
    ...
    return (
      (a = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.MULTIREL, a, b.rel)),
...
sre.SemanticProcessor.prototype.operationsInRow_ = function(a) {
  if (0 === a.length) return sre.SemanticProcessor.getInstance().factory_.makeEmptyNode();
  if (1 === a.length) return a[0];
  for (var b = []; 0 < a.length && sre.SemanticPred.isOperator(a[0]); ) b.push(a.shift());
  if (0 === a.length) return sre.SemanticProcessor.getInstance().prefixNode_(b.pop(), b);
  if (1 === a.length) return sre.SemanticProcessor.getInstance().prefixNode_(a[0], b);
  a = sre.SemanticProcessor.sliceNodes_(a, sre.SemanticPred.isOperator);
  b = sre.SemanticProcessor.getInstance().prefixNode_(sre.SemanticProcessor.getInstance().implicitNode_(a.head), b);
  return a.div ? sre.SemanticProcessor.getInstance().operationsTree_(a.tail, b, a.div) : b;
};
  ...
  if (0 === a.length)
    return (
      ...
      b.type === sre.SemanticAttr.Type.INFIXOP
        ? ((d = sre.SemanticProcessor.getInstance().postfixNode_(b.childNodes.pop(), d)), b.appendChild(d), b)
        : sre.SemanticProcessor.getInstance().postfixNode_(b, d)
    );
  a = sre.SemanticProcessor.sliceNodes_(a, sre.SemanticPred.isOperator);
  if (0 === a.head.length) return d.push(a.div), sre.SemanticProcessor.getInstance().operationsTree_(a.tail, b, c, d);
  d = sre.SemanticProcessor.getInstance().prefixNode_(sre.SemanticProcessor.getInstance().implicitNode_(a.head), d);
...
sre.SemanticProcessor.prototype.appendMultiplicativeOp_ = function(a, b, c) {
  if (a.role === sre.SemanticAttr.Role.IMPLICIT) return sre.SemanticProcessor.getInstance().infixNode_([a, c], b);
  ...
  b = sre.SemanticProcessor.getInstance().infixNode_([d.childNodes.pop(), c], b);
  d.appendChild(b);
  return a;
};
...
sre.SemanticProcessor.prototype.appendExistingOperator_ = function(a, b, c) {
  return a && a.type === sre.SemanticAttr.Type.INFIXOP && a.role !== sre.SemanticAttr.Role.IMPLICIT
    ? a.contentNodes[0].equals(b)
      ? (a.appendContentNode(b), a.appendChild(c), !0)
      : sre.SemanticProcessor.getInstance().appendExistingOperator_(a.childNodes[a.childNodes.length - 1], b, c)
    : !1;
};
...
sre.SemanticProcessor.prototype.fences_ = function(a, b, c, d) {
  ...
  if (0 === a.length) {
    for (a = d.shift(); 0 < c.length; ) {
      if (e(c[0])) (b = c.shift()), sre.SemanticProcessor.fenceToPunct_(b), a.push(b);
      else {
        c = sre.SemanticProcessor.sliceNodes_(c, e);
        var f = c.head.length - 1,
          g = sre.SemanticProcessor.getInstance().neutralFences_(c.head, d.slice(0, f));
        d = d.slice(f);
        a.push.apply(a, g);
  ...
  if (
    ...
    (g === sre.SemanticAttr.Role.NEUTRAL && (!f || a[0].textContent !== f.textContent))
  )
    return c.push(a.shift()), (e = b.shift()) && d.push(e), sre.SemanticProcessor.getInstance().fences_(a, b, c, d);
  if (
    f &&
    ((g === sre.SemanticAttr.Role.CLOSE && f.role === sre.SemanticAttr.Role.OPEN) ||
      (g === sre.SemanticAttr.Role.NEUTRAL && a[0].textContent === f.textContent))
  )
    return (
      (e = sre.SemanticProcessor.getInstance().horizontalFencedNode_(c.pop(), a.shift(), d.pop())),
      d.push(d.pop().concat([e], b.shift())),
      sre.SemanticProcessor.getInstance().fences_(a, b, c, d)
    );
  if (f && g === sre.SemanticAttr.Role.CLOSE && f.role === sre.SemanticAttr.Role.NEUTRAL && c.some(e))
    return (
      (c = sre.SemanticProcessor.sliceNodes_(c, e, !0)),
      (e = d.pop()),
      (f = d.length - c.tail.length + 1),
      (g = sre.SemanticProcessor.getInstance().neutralFences_(c.tail, d.slice(f))),
      (d = d.slice(0, f)),
      (e = sre.SemanticProcessor.getInstance().horizontalFencedNode_(c.div, a.shift(), d.pop().concat(g, e))),
      d.push(d.pop().concat([e], b.shift())),
...
sre.SemanticProcessor.prototype.neutralFences_ = function(a, b) {
  ...
  b = sre.SemanticProcessor.getInstance().combineFencedContent_(c, d.div, d.head, b);
  return 0 < d.tail.length
    ? ((a = b.shift()), (d = sre.SemanticProcessor.getInstance().neutralFences_(d.tail, b)), a.concat(d))
    : b[0];
};
sre.SemanticProcessor.prototype.combineFencedContent_ = function(a, b, c, d) {
  if (0 === c.length)
    return (
      (a = sre.SemanticProcessor.getInstance().horizontalFencedNode_(a, b, d.shift())),
...
sre.SemanticProcessor.FENCE_TO_PUNCT_[sre.SemanticAttr.Role.NEUTRAL] = sre.SemanticAttr.Role.VBAR;
sre.SemanticProcessor.FENCE_TO_PUNCT_[sre.SemanticAttr.Role.OPEN] = sre.SemanticAttr.Role.OPENFENCE;
sre.SemanticProcessor.FENCE_TO_PUNCT_[sre.SemanticAttr.Role.CLOSE] = sre.SemanticAttr.Role.CLOSEFENCE;
sre.SemanticProcessor.fenceToPunct_ = function(a) {
  var b = sre.SemanticProcessor.FENCE_TO_PUNCT_[a.role];
  if (b) {
    for (; a.embellished; ) (a.embellished = sre.SemanticAttr.Type.PUNCTUATION), (a.role = b), (a = a.childNodes[0]);
...
sre.SemanticProcessor.prototype.horizontalFencedNode_ = function(a, b, c) {
  ...
  b = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.FENCED, [c], [a, b]);
...
sre.SemanticProcessor.prototype.getPunctuationInRow_ = function(a) {
  if (1 >= a.length) return a;
  var b = sre.SemanticProcessor.partitionNodes_(a, function(a) {
    return sre.SemanticPred.isPunctuation(a) && !sre.SemanticPred.isAttribute("role", "ELLIPSIS")(a);
  });
  if (0 === b.rel.length) return a;
  a = [];
  var c = b.comp.shift();
  ...
  for (var d = 0; 0 < b.comp.length; )
    a.push(b.rel[d++]), (c = b.comp.shift()), 0 < c.length && a.push(sre.SemanticProcessor.getInstance().row(c));
...
sre.SemanticProcessor.prototype.punctuatedNode_ = function(a, b) {
  var c = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.PUNCTUATED, a, b);
...
sre.SemanticProcessor.prototype.limitNode = function(a, b) {
  var c = b[0];
  if (sre.SemanticPred.isLimitBase(c)) a = sre.SemanticProcessor.MML_TO_LIMIT_[a];
  else
    switch (a) {
      case "MSUB":
      ...
      case "MOVER":
        ...
        sre.SemanticPred.isAccent(b[1]) && (b[1].role = sre.SemanticAttr.Role.OVERACCENT);
        break;
      case "MUNDER":
        a = sre.SemanticAttr.Type.UNDERSCORE;
        sre.SemanticPred.isAccent(b[1]) && (b[1].role = sre.SemanticAttr.Role.UNDERACCENT);
        break;
      default:
...
sre.SemanticProcessor.prototype.getFunctionsInRow_ = function(a, b) {
  ...
  if (!d) return b.push(c), sre.SemanticProcessor.getInstance().getFunctionsInRow_(a, b);
  a = sre.SemanticProcessor.getInstance().getFunctionsInRow_(a, []);
...
sre.SemanticProcessor.CLASSIFY_FUNCTION_[sre.SemanticAttr.Role.PREFIXFUNC] = "prefix";
sre.SemanticProcessor.CLASSIFY_FUNCTION_[sre.SemanticAttr.Role.LIMFUNC] = "prefix";
sre.SemanticProcessor.classifyFunction_ = function(a, b) {
  ...
  if (b[0] && b[0].textContent === sre.SemanticAttr.functionApplication()) {
    ...
    if (a.role === sre.SemanticAttr.Role.PREFIXFUNC || a.role === sre.SemanticAttr.Role.LIMFUNC) b = a.role;
  ...
  switch (c) {
    ...
    case "prefix":
      if (b[0] && b[0].type === sre.SemanticAttr.Type.FENCED)
        return (a = sre.SemanticProcessor.getInstance().functionNode_(a, b.shift())), b.unshift(a), b;
    case "bigop":
      d = sre.SemanticProcessor.sliceNodes_(b, sre.SemanticPred.isPrefixFunctionBoundary);
    ...
    default:
      ...
      if (
        ...
        return (
          sre.SemanticProcessor.propagateFunctionRole_(a, sre.SemanticAttr.Role.SIMPLEFUNC),
...
sre.SemanticProcessor.prototype.getIntegralArgs_ = function(a, b) {
  ...
  var c = a[0];
  if (sre.SemanticPred.isGeneralFunctionBoundary(c)) return { integrand: b, intvar: null, rest: a };
  if (sre.SemanticPred.isIntegralDxBoundarySingle(c)) return { integrand: b, intvar: c, rest: a.slice(1) };
  if (a[1] && sre.SemanticPred.isIntegralDxBoundary(c, a[1])) {
    var d = sre.SemanticProcessor.getInstance().factory_.makeContentNode(sre.SemanticAttr.invisibleComma());
...
sre.SemanticProcessor.prototype.functionNode_ = function(a, b) {
  var c = sre.SemanticProcessor.getInstance().factory_.makeContentNode(sre.SemanticAttr.functionApplication());
  ...
  var d = sre.SemanticProcessor.getFunctionOp_(a, function(a) {
    return (
      ...
      (sre.SemanticPred.isAttribute("type", "IDENTIFIER")(a) && sre.SemanticPred.isAttribute("role", "SIMPLEFUNC")(a))
    );
  });
  return sre.SemanticProcessor.getInstance().functionalNode_(sre.SemanticAttr.Type.APPL, [a, b], d, [c]);
};
sre.SemanticProcessor.prototype.bigOpNode_ = function(a, b) {
  var c = sre.SemanticProcessor.getFunctionOp_(a, sre.SemanticPred.isAttribute("type", "LARGEOP"));
  return sre.SemanticProcessor.getInstance().functionalNode_(sre.SemanticAttr.Type.BIGOP, [a, b], c, []);
};
sre.SemanticProcessor.prototype.integralNode_ = function(a, b, c) {
  ...
  var d = sre.SemanticProcessor.getFunctionOp_(a, sre.SemanticPred.isAttribute("type", "LARGEOP"));
  return sre.SemanticProcessor.getInstance().functionalNode_(sre.SemanticAttr.Type.INTEGRAL, [a, b, c], d, []);
};
...
sre.SemanticProcessor.getFunctionOp_ = function(a, b) {
  if (b(a)) return a;
  for (var c = 0, d; (d = a.childNodes[c]); c++) if ((d = sre.SemanticProcessor.getFunctionOp_(d, b))) return d;
  return null;
};
sre.SemanticProcessor.prototype.tablesInRow = function(a) {
  a = sre.SemanticProcessor.partitionNodes_(a, sre.SemanticPred.tableIsMatrixOrVector);
  for (var b = [], c = 0, d; (d = a.rel[c]); c++)
    (b = b.concat(a.comp.shift())), b.push(sre.SemanticProcessor.tableToMatrixOrVector_(d));
  b = b.concat(a.comp.shift());
  a = sre.SemanticProcessor.partitionNodes_(b, sre.SemanticPred.isTableOrMultiline);
  b = [];
  for (c = 0; (d = a.rel[c]); c++) {
    var e = a.comp.shift();
    sre.SemanticPred.tableIsCases(d, e) && sre.SemanticProcessor.tableToCases_(d, e.pop());
    b = b.concat(e);
    b.push(d);
  }
...
sre.SemanticProcessor.tableToMatrixOrVector_ = function(a) {
  ...
  for (var c; (c = b.childNodes[a]); a++)
    sre.SemanticProcessor.assignRoleToRow_(c, sre.SemanticProcessor.getComponentRoles_(b));
  b.parent = null;
  return b;
};
sre.SemanticProcessor.tableToVector_ = function(a) {
  ...
  1 === b.childNodes.length ? sre.SemanticProcessor.tableToSquare_(a) : sre.SemanticProcessor.binomialForm_(b);
};
...
sre.SemanticProcessor.tableToMatrix_ = function(a) {
  ...
  b.childNodes.length === b.childNodes[0].childNodes.length
    ...
    : b.childNodes && 1 === b.childNodes.length && (b.role = sre.SemanticAttr.Role.ROWVECTOR);
};
...
sre.SemanticProcessor.getComponentRoles_ = function(a) {
  ...
  return b && b !== sre.SemanticAttr.Role.UNKNOWN
    ? b
    : sre.SemanticAttr.Role[a.type.toUpperCase()] || sre.SemanticAttr.Role.UNKNOWN;
};
sre.SemanticProcessor.tableToCases_ = function(a, b) {
  for (var c = 0, d; (d = a.childNodes[c]); c++) sre.SemanticProcessor.assignRoleToRow_(d, sre.SemanticAttr.Role.CASES);
  a.type = sre.SemanticAttr.Type.CASES;
  a.appendContentNode(b);
  sre.SemanticPred.tableIsMultiline(a) && sre.SemanticProcessor.binomialForm_(a);
  return a;
};
sre.SemanticProcessor.tableToMultiline = function(a) {
  if (sre.SemanticPred.tableIsMultiline(a)) {
    ...
    for (var b = 0, c; (c = a.childNodes[b]); b++) sre.SemanticProcessor.rowToLine_(c, sre.SemanticAttr.Role.MULTILINE);
...
sre.SemanticProcessor.sliceNodes_ = function(a, b, c) {
  ...
  return c ? { head: [], div: null, tail: d.reverse() } : { head: d, div: null, tail: [] };
};
...
sre.SemanticProcessor.prototype.mfenced = function(a, b, c, d) {
  ...
  a && d.unshift(sre.SemanticProcessor.getInstance().factory_.makeContentNode(a));
...
sre.SemanticProcessor.number = function(a) {
  if (a.type === sre.SemanticAttr.Type.UNKNOWN || a.type === sre.SemanticAttr.Type.IDENTIFIER)
...
sre.SemanticProcessor.numberRole_ = function(a) {
  if (a.role === sre.SemanticAttr.Role.UNKNOWN) {
    ...
    b.every(function(a) {
      return (
        (a.type === sre.SemanticAttr.Type.NUMBER && a.role === sre.SemanticAttr.Role.INTEGER) ||
        (a.type === sre.SemanticAttr.Type.PUNCTUATION && a.role === sre.SemanticAttr.Role.COMMA)
      );
    })
      ? (a.role = sre.SemanticAttr.Role.INTEGER)
      : b.every(function(a) {
...
sre.SemanticProcessor.exprFont_ = function(a) {
  if (a.font === sre.SemanticAttr.Font.UNKNOWN) {
    var b = sre.SemanticUtil.splitUnicode(a.textContent)
      ...
      .reduce(function(a, b) {
        return a && b.font && b.font !== sre.SemanticAttr.Font.UNKNOWN && b.font !== a
...
sre.SemanticProcessor.prototype.fractionLikeNode = function(a, b, c) {
  return sre.SemanticUtil.isZeroLength(a)
    ? ((a = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.LINE, [b], [])),
      (c = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.LINE, [c], [])),
      (c = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.MULTILINE, [a, c], [])),
...
sre.SemanticProcessor.prototype.fractionNode_ = function(a, b) {
  a = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(sre.SemanticAttr.Type.FRACTION, [a, b], []);
...
sre.SemanticProcessor.prototype.tensor = function(a, b, c, d, e) {
  b = sre.SemanticProcessor.getInstance().factory_.makeBranchNode(
    ...
    [
      a,
      sre.SemanticProcessor.getInstance().scriptNode_(b, sre.SemanticAttr.Role.LEFTSUB),
      sre.SemanticProcessor.getInstance().scriptNode_(c, sre.SemanticAttr.Role.LEFTSUPER),
      sre.SemanticProcessor.getInstance().scriptNode_(d, sre.SemanticAttr.Role.RIGHTSUB),
      sre.SemanticProcessor.getInstance().scriptNode_(e, sre.SemanticAttr.Role.RIGHTSUPER)
    ],
    []
  );
  b.role = a.role;
...
sre.SemanticProcessor.prototype.pseudoTensor = function(a, b, c) {
  ...
  a = [a];
  e && a.push(sre.SemanticProcessor.getInstance().scriptNode_(b, sre.SemanticAttr.Role.RIGHTSUB, !0));
  d && a.push(sre.SemanticProcessor.getInstance().scriptNode_(c, sre.SemanticAttr.Role.RIGHTSUPER, !0));
...
sre.SemanticProcessor.purgeFences_ = function(a) {
  ...
  for (var c = [], d = []; 0 < b.length; ) {
    ...
    sre.SemanticPred.isElligibleEmbellishedFence(e)
      ? (c.push(e), d.push(f))
      : (sre.SemanticProcessor.fenceToPunct_(e), f.push(e), (f = f.concat(a.shift())), a.unshift(f));
  }
  d.push(a.shift());
  return { rel: c, comp: d };
};
...
sre.SemanticProcessor.classifyMultiline = function(a) {
  for (var b = 0, c = a.childNodes.length, d; b < c && (!(d = a.childNodes[b]) || !d.childNodes.length); ) b++;
  if (!(b >= c)) {
    ...
    e !== sre.SemanticAttr.Role.UNKNOWN &&
      a.childNodes.every(function(a) {
        ...
        return (
          !a ||
          (a.role === e &&
            (sre.SemanticPred.isAttribute("type", "RELATION")(a) || sre.SemanticPred.isAttribute("type", "RELSEQ")(a)))
        );
      }) &&
      (a.role = e);
  }
...
sre.SemanticProcessor.classifyTable = function(a) {
  ...
  sre.SemanticProcessor.classifyByColumns_(a, b, "EQUALITY") ||
    sre.SemanticProcessor.classifyByColumns_(a, b, "INEQUALITY", ["EQUALITY"]) ||
...
sre.SemanticProcessor.classifyByColumns_ = function(a, b, c, d) {
  ...
  var e = function(a) {
      return sre.SemanticProcessor.isEndRelation_(a, c) || sre.SemanticProcessor.isPureRelation_(a, c);
    },
    f = function(a) {
      return sre.SemanticProcessor.isEndRelation_(a, c, !0) || sre.SemanticProcessor.isPureRelation_(a, c);
    };
  return (3 === b.length && sre.SemanticProcessor.testColumns_(b, 1, d)) ||
    (2 === b.length && (sre.SemanticProcessor.testColumns_(b, 1, e) || sre.SemanticProcessor.testColumns_(b, 0, f)))
...
sre.SemanticProcessor.isPureRelation_ = function(a, b) {
  return sre.SemanticPred.isAttribute("type", "RELATION")(a) && sre.SemanticPred.isAttribute("role", b)(a);
};
sre.SemanticProcessor.computeColumns_ = function(a) {
  for (var b = [], c = 0, d; (d = a.childNodes[c]); c++)
    for (var e = 0, f; (f = d.childNodes[e]); e++) b[e] ? b[e].push(f) : (b[e] = [f]);
  return b;
};
...
sre.SemanticMathml.prototype.parse = function(a) {
  ...
  if (-1 !== ["MATH", "MROW", "MPADDED", "MSTYLE", "SEMANTICS"].indexOf(c)) return b;
  b.mathml.unshift(a);
  b.mathmlTree = a;
  return b;
};
...
sre.SemanticMathml.prototype.rows_ = function(a, b) {
  ...
  b = 1 === b.length ? this.parse(b[0]) : sre.SemanticProcessor.getInstance().row(this.parseNodes_(b));
  b.mathml.unshift(a);
  return b;
};
...
sre.SemanticMathml.prototype.limits_ = function(a, b) {
  return sre.SemanticProcessor.getInstance().limitNode(sre.DomUtil.tagName(a), this.parseNodes_(b));
};
sre.SemanticMathml.prototype.root_ = function(a, b) {
  return this.getFactory().makeBranchNode(sre.SemanticAttr.Type.ROOT, [this.parse(b[1]), this.parse(b[0])], []);
};
sre.SemanticMathml.prototype.sqrt_ = function(a, b) {
  a = this.parseNodes_(sre.SemanticUtil.purgeNodes(b));
  return this.getFactory().makeBranchNode(sre.SemanticAttr.Type.SQRT, [sre.SemanticProcessor.getInstance().row(a)], []);
};
sre.SemanticMathml.prototype.table_ = function(a, b) {
  a = this.getFactory().makeBranchNode(sre.SemanticAttr.Type.TABLE, this.parseNodes_(b), []);
  sre.SemanticProcessor.tableToMultiline(a);
  return a;
};
sre.SemanticMathml.prototype.tableRow_ = function(a, b) {
  a = this.getFactory().makeBranchNode(sre.SemanticAttr.Type.ROW, this.parseNodes_(b), []);
...
sre.SemanticMathml.prototype.tableLabeledRow_ = function(a, b) {
  ...
  b = this.getFactory().makeBranchNode(sre.SemanticAttr.Type.ROW, this.parseNodes_(b.slice(1)), [a]);
...
sre.SemanticMathml.prototype.operator_ = function(a, b) {
  a = this.leaf_(a);
  a.type === sre.SemanticAttr.Type.UNKNOWN && (a.type = sre.SemanticAttr.Type.OPERATOR);
  return a;
};
...
sre.SemanticMathml.prototype.enclosed_ = function(a, b) {
  b = this.parseNodes_(sre.SemanticUtil.purgeNodes(b));
  b = this.getFactory().makeBranchNode(sre.SemanticAttr.Type.ENCLOSE, [sre.SemanticProcessor.getInstance().row(b)], []);
...
sre.SemanticMathml.prototype.multiscripts_ = function(a, b) {
  ...
  for (var c = [], d = [], e = [], f = [], g = !1, h = 0, k = 0, l; (l = b[k]); k++)
    "MPRESCRIPTS" === sre.DomUtil.tagName(l)
      ? ((g = !0), (h = 0))
      : (g ? (h & 1 ? c.push(l) : d.push(l)) : h & 1 ? e.push(l) : f.push(l), h++);
  return sre.SemanticUtil.purgeNodes(c).length || sre.SemanticUtil.purgeNodes(d).length
    ...
    : sre.SemanticProcessor.getInstance().pseudoTensor(a, this.parseNodes_(f), this.parseNodes_(e));
};
...
sre.SemanticSkeleton.interleaveIds = function(a, b) {
  return sre.BaseUtil.interleaveLists(sre.SemanticSkeleton.collapsedLeafs(a), sre.SemanticSkeleton.collapsedLeafs(b));
};
...
sre.EnrichMathml.enrich = function(a, b) {
  ...
  sre.Engine.getInstance().structure &&
    a.setAttribute(sre.EnrichMathml.Attribute.STRUCTURE, sre.SemanticSkeleton.fromStructure(b).toString());
...
sre.EnrichMathml.walkTree = function(a) {
  ...
  b = a.mathmlTree;
  if (null === b) sre.Debugger.getInstance().output("Walktree Case 1"), (b = sre.EnrichMathml.introduceNewLayer(c));
  else {
    var d = sre.EnrichMathml.attachedElement_(c);
    sre.Debugger.getInstance().output("Walktree Case 2");
    d
      ? (sre.Debugger.getInstance().output("Walktree Case 2.1"), (b = d.parentNode))
      : (sre.Debugger.getInstance().output("Walktree Case 2.2"), (b = sre.EnrichMathml.getInnerNode(b)));
  }
...
sre.EnrichMathml.moveSemanticAttributes_ = function(a, b) {
  for (var c in sre.EnrichMathml.Attribute) {
    ...
    a.hasAttribute(d) && (b.setAttribute(d, a.getAttribute(d)), a.removeAttribute(d));
  }
};
  ...
  if (c.length)
    for (var d = 0; b.length; )
      c[d] === b[0] || sre.EnrichMathml.functionApplication_(c[d], b[0])
        ...
        : c[d] && -1 === b.indexOf(c[d])
          ? d++
          : (sre.EnrichMathml.isDescendant_(b[0], a) || a.insertBefore(b[0], c[d] || null), b.shift());
  else
...
sre.EnrichMathml.attachedElement_ = function(a) {
  for (var b = 0, c = null; !c && b < a.length; ) a[b].parentNode && (c = a[b]), b++;
  return c;
};
...
sre.EnrichMathml.ascendNewNode = function(a) {
  for (; !sre.SemanticUtil.hasMathTag(a) && sre.EnrichMathml.unitChild_(a); ) a = sre.EnrichMathml.parentNode_(a);
  return a;
};
sre.EnrichMathml.descendNode_ = function(a) {
  ...
  return 1 === b.length && sre.SemanticUtil.hasEmptyTag(b[0]) && !b[0].hasAttribute(sre.EnrichMathml.Attribute.TYPE)
...
sre.EnrichMathml.setAttributes = function(a, b) {
  ...
  b.font != sre.Semantic.Font.UNKNOWN && a.setAttribute(sre.EnrichMathml.Attribute.FONT, b.font);
  ...
  b.contentNodes.length &&
    a.setAttribute(sre.EnrichMathml.Attribute.CONTENT, sre.EnrichMathml.makeIdList(b.contentNodes));
...
sre.EnrichMathml.rewriteMfenced = function(a) {
  ...
  for (var b = sre.DomUtil.createElement("mrow"), c = 0, d; (d = a.attributes[c]); c++)
...
sre.EnrichMathml.getInnerNode = function(a) {
  ...
  if (!b) return a;
  b = b.filter(function(a) {
    return a.nodeType === sre.DomUtil.NodeType.ELEMENT_NODE && !sre.EnrichMathml.isIgnorable_(a);
  });
...
sre.CaseBinomial.test = function(a) {
  return !a.mathmlTree && a.type === sre.SemanticAttr.Type.LINE && a.role === sre.SemanticAttr.Role.BINOMIAL;
};
...
sre.CaseDoubleScript.prototype.getMathml = function() {
  ...
  sre.EnrichMathml.setAttributes(this.mml, this.semantic);
  this.mml.setAttribute(sre.EnrichMathml.Attribute.CHILDREN, sre.EnrichMathml.makeIdList([b, d, c]));
  [f, g, e].forEach(
    goog.bind(function(a) {
  ...
  sre.EnrichMathml.addCollapsedAttribute(this.mml, [this.semantic.id, [a.id, b.id, d.id], c.id]);
  return this.mml;
};
  ...
  var c = sre.DomUtil.toArray(this.mml.childNodes).slice(1),
    ...
    e = goog.bind(function(a) {
      for (var b = 0, e; (e = a[b]); b++) {
        var f = c[d];
        if (f && e == sre.EnrichMathml.getInnerNode(f).getAttribute(sre.EnrichMathml.Attribute.ID))
          sre.EnrichMathml.getInnerNode(f).setAttribute(sre.EnrichMathml.Attribute.PARENT, this.semantic.id), d++;
        else {
          var l = this.semantic.querySelectorAll(function(a) {
            return a.id === e;
          });
          this.mml.insertBefore(sre.CaseMultiindex.createNone_(l[0]), f || null);
        }
      }
    }, this);
  e(a);
...
sre.CaseMultiscripts.test = function(a) {
  return a.mathmlTree
    ? "MMULTISCRIPTS" === sre.DomUtil.tagName(a.mathmlTree) &&
        (a.type === sre.SemanticAttr.Type.SUPERSCRIPT || a.type === sre.SemanticAttr.Type.SUBSCRIPT)
    : !1;
};
...
sre.CaseEmbellished.prototype.getFenced_ = function() {
  for (var a = this.semantic; a.type !== sre.SemanticAttr.Type.FENCED; ) a = a.childNodes[0];
...
sre.CaseEmbellished.prototype.getFencesMml_ = function() {
  for (
    var a = this.semantic, b = Object.keys(this.ofenceMap), c = Object.keys(this.cfenceMap);
    !((this.ofenceMml && this.cfenceMml) || a === this.fenced);

  )
    -1 === b.indexOf(a.fencePointer) || this.ofenceMml || (this.ofenceMml = a.mathmlTree),
      -1 === c.indexOf(a.fencePointer) || this.cfenceMml || (this.cfenceMml = a.mathmlTree),
      (a = a.childNodes[0]);
  this.ofenceMml || (this.ofenceMml = this.ofence.mathmlTree);
  this.cfenceMml || (this.cfenceMml = this.cfence.mathmlTree);
  this.ofenceMml && (this.ofenceMml = sre.EnrichMathml.ascendNewNode(this.ofenceMml));
...
sre.CaseEmbellished.prototype.rewrite_ = function() {
  ...
  for (sre.EnrichMathml.setAttributes(c, this.fenced.parent); a.type !== sre.SemanticAttr.Type.FENCED; ) {
    ...
    if (e) a = e;
      ...
      e = [];
      for (var f = 1, g; (g = a.childNodes[f]); f++) e.push(sre.EnrichMathml.walkTree(g));
      a = a.childNodes[0];
    }
...
sre.CaseEmbellished.prototype.specialCase_ = function(a, b) {
  ...
  if ("MSUBSUP" === c) {
    ...
    "MMULTISCRIPTS" === c &&
      ...
      (d = e && a.childNodes[0] && a.childNodes[0].role === sre.SemanticAttr.Role.SUBSUP ? a.childNodes[0] : a));
  if (!d) return null;
  c = d.childNodes[0];
...
sre.CaseEmbellished.prototype.introduceNewLayer_ = function() {
  ...
  c.appendChild(b);
  if (!c.parentNode) {
    for (a = sre.DomUtil.createElement("mrow"); 0 < c.childNodes.length; ) a.appendChild(c.childNodes[0]);
    c.appendChild(a);
    c = a;
  }
  return c;
...
sre.CaseEmbellished.prototype.fullFence = function(a) {
  for (var b = this.fencedMml.parentNode; a.parentNode && a.parentNode !== b; ) a = a.parentNode;
  return a;
};
...
sre.CaseLine.prototype.getMathml = function() {
  this.semantic.contentNodes.length && sre.EnrichMathml.walkTree(this.semantic.contentNodes[0]);
...
sre.CaseTable.prototype.getMathml = function() {
  var a = sre.EnrichMathml.cloneContentNode(this.semantic.contentNodes[0]),
    b = this.semantic.contentNodes[1] ? sre.EnrichMathml.cloneContentNode(this.semantic.contentNodes[1]) : null;
  ...
  "MFENCED" === sre.DomUtil.tagName(this.mml)
    ...
    : ((a = [a, this.mml]), b && a.push(b), (this.mml = sre.EnrichMathml.introduceNewLayer(a)));
  sre.EnrichMathml.setAttributes(this.mml, this.semantic);
  return this.mml;
};
...
sre.CaseTensor.prototype.getMathml = function() {
  ...
  sre.EnrichMathml.setAttributes(this.mml, this.semantic);
  sre.EnrichMathml.addCollapsedAttribute(this.mml, [this.semantic.id, this.semantic.childNodes[0].id, a, b, c, d]);
  ...
  this.completeMultiscript(sre.SemanticSkeleton.interleaveIds(c, d), sre.SemanticSkeleton.interleaveIds(a, b));
  return this.mml;
};
...
sre.CaseText.test = function(a) {
  return a.type === sre.SemanticAttr.Type.PUNCTUATED && a.role === sre.SemanticAttr.Role.TEXT;
};
...
sre.AbstractHighlighter.prototype.addEvents = function(a, b) {
  a = this.getMactionNodes(a);
  for (var c = 0, d; (d = a[c]); c++) for (var e in b) d.addEventListener(e, b[e]);
};
...
sre.AbstractHighlighter.prototype.isMactionNode = function(a) {
  return (a = a.className || a.getAttribute("class")) ? a.match(new RegExp(this.mactionName)) : !1;
};
...
sre.SvgHighlighter.prototype.unhighlightNode = function(a) {
  "background" in a
    ? ((a.node.style.backgroundColor = a.background), (a.node.style.color = a.foreground))
    : (a.foreground
...
sre.SvgHighlighter.prototype.isMactionNode = function(a) {
  ...
  return (a = a.baseVal ? a.baseVal : a) ? a.match(new RegExp(this.mactionName)) : !1;
};
...
sre.HighlighterFactory.highlighter = function(a, b, c) {
  ...
  c =
    sre.HighlighterFactory.highlighterMapping_[
      "NativeMML" === c.renderer && "Safari" === c.browser ? "MML-CSS" : c.renderer
    ];
  if (!c) return null;
  c.setColor(a);
  return c;
...
sre.Grammar.prototype.apply = function(a, b) {
  ...
  if (this.parameters_.translate || b.translate) a = sre.Grammar.translateString_(a);
...
sre.MathspeakUtil.spaceoutNumber = function(a) {
  ...
  for (var b = [], c = new sre.SystemExternal.xmldom.DOMParser(), d = 0, e; (e = a[d]); d++) {
    var f = sre.Semantic.Type.NUMBER,
      g = e.match(/\W/) ? sre.Semantic.Role.UNKNOWN : sre.Semantic.Role.PROTECTED;
...
sre.MathspeakUtil.spaceoutIdentifier = function(a) {
  var b = a.textContent;
  if (!b.match(/[a-zA-Z]+/)) return a.setAttribute("role", sre.SemanticAttr.Role.PROTECTED), [a];
  a = b.split("");
  b = [];
  for (var c = new sre.SystemExternal.xmldom.DOMParser(), d = 0, e; (e = a[d]); d++) {
...
sre.MathspeakUtil.getNestingDepth = function(a, b, c, d, e, f) {
  ...
  if (sre.MathspeakUtil.nestingDepth[a][g]) return sre.MathspeakUtil.nestingDepth[a][g];
...
sre.MathspeakUtil.containsAttr = function(a, b) {
  ...
  for (var c = 0, d; (d = a[c]); c++) if (b[d.nodeName] === d.nodeValue) return !0;
  return !1;
};
sre.MathspeakUtil.computeNestingDepth_ = function(a, b, c, d, e, f) {
  if (e(a) || -1 < c.indexOf(a.tagName) || sre.MathspeakUtil.containsAttr(a, d)) return f;
...
sre.MathspeakUtil.openingFractionSbrief = function(a) {
  ...
  return 1 === a
    ...
    : sre.Messages.MS.NEST_FRAC + sre.Messages.MS_FUNC.RADICAL_NEST_DEPTH(a - 1) + sre.Messages.MS.FRAC_S;
};
sre.MathspeakUtil.closingFractionSbrief = function(a) {
  a = sre.MathspeakUtil.fractionNestingDepth(a);
  return 1 === a
    ? sre.Messages.MS.ENDFRAC
    : sre.Messages.MS.NEST_FRAC + sre.Messages.MS_FUNC.RADICAL_NEST_DEPTH(a - 1) + sre.Messages.MS.ENDFRAC;
};
sre.MathspeakUtil.overFractionSbrief = function(a) {
  a = sre.MathspeakUtil.fractionNestingDepth(a);
  return 1 === a
    ? sre.Messages.MS.FRAC_OVER
    : sre.Messages.MS.NEST_FRAC + sre.Messages.MS_FUNC.RADICAL_NEST_DEPTH(a - 1) + sre.Messages.MS.OVER;
};
  ...
  (a %= 100) &&
    (b =
      ...
      (sre.MathspeakUtil.onesNumbers[a] ||
        sre.MathspeakUtil.tensNumbers[Math.floor(a / 10)] + "-" + sre.MathspeakUtil.onesNumbers[a % 10]));
  return b;
};
sre.MathspeakUtil.numberToWords = function(a) {
  ...
  for (var b = 0, c = ""; 0 < a; )
    a % 1e3 &&
      (c = sre.MathspeakUtil.hundredsToWords(a % 1e3) + (b ? "-" + sre.MathspeakUtil.largeNumbers[b] + "-" : "") + c),
      (a = Math.floor(a / 1e3)),
      b++;
  return c;
};
...
sre.MathspeakUtil.convertVulgarFraction_ = function(a) {
  if (
    ...
    a.childNodes[0].childNodes[0].getAttribute("role") !== sre.SemanticAttr.Role.INTEGER ||
    a.childNodes[0].childNodes[1].tagName !== sre.SemanticAttr.Type.NUMBER ||
    a.childNodes[0].childNodes[1].getAttribute("role") !== sre.SemanticAttr.Role.INTEGER
  )
...
sre.MathspeakUtil.nestedSubSuper = function(a, b, c) {
  for (; a.parentNode; ) {
    ...
    if (
      ...
      (e.tagName === sre.Semantic.Type.TENSOR &&
        f &&
        (f === sre.Semantic.Role.LEFTSUPER || f === sre.Semantic.Role.RIGHTSUPER))
    )
      b = c.sup + " " + b;
    a = e;
  }
...
sre.MathspeakUtil.nestedRadical = function(a, b, c) {
  ...
  c = (a = sre.MathspeakUtil.getRootIndex(a)) ? sre.Messages.MS_FUNC.COMBINE_ROOT_INDEX(c, a) : c;
  return 1 === d ? c : b + sre.Messages.MS_FUNC.RADICAL_NEST_DEPTH(d - 1) + c;
};
sre.MathspeakUtil.getRootIndex = function(a) {
  a = "sqrt" === a.tagName ? "2" : sre.XpathUtil.evalXPath("children/*[1]", a)[0].textContent.trim();
  return sre.Messages.MS_ROOT_INDEX[a] || "";
};
sre.MathspeakUtil.openingRadicalVerbose = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NESTED, sre.Messages.MS.STARTROOT);
};
sre.MathspeakUtil.closingRadicalVerbose = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NESTED, sre.Messages.MS.ENDROOT);
};
sre.MathspeakUtil.indexRadicalVerbose = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NESTED, sre.Messages.MS.ROOTINDEX);
};
sre.MathspeakUtil.openingRadicalBrief = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NEST_ROOT, sre.Messages.MS.STARTROOT);
};
sre.MathspeakUtil.closingRadicalBrief = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NEST_ROOT, sre.Messages.MS.ENDROOT);
};
sre.MathspeakUtil.indexRadicalBrief = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NEST_ROOT, sre.Messages.MS.ROOTINDEX);
};
sre.MathspeakUtil.openingRadicalSbrief = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NEST_ROOT, sre.Messages.MS.ROOT);
};
sre.MathspeakUtil.indexRadicalSbrief = function(a) {
  return sre.MathspeakUtil.nestedRadical(a, sre.Messages.MS.NEST_ROOT, sre.Messages.MS.INDEX);
};
  ...
  return sre.MathspeakUtil.getNestingDepth(
    ...
    function(a) {
      return (
        ...
        a.childNodes[0].childNodes[1].getAttribute("role") === sre.Semantic.Role.UNDERACCENT
      );
    }
  );
};
  ...
  return sre.MathspeakUtil.getNestingDepth(
    ...
    function(a) {
      return (
        ...
        a.childNodes[0].childNodes[1].getAttribute("role") === sre.Semantic.Role.OVERACCENT
      );
    }
  );
};
...
sre.MathspeakUtil.determinantIsSimple = function(a) {
  if (a.tagName !== sre.Semantic.Type.MATRIX || a.getAttribute("role") !== sre.Semantic.Role.DETERMINANT) return [];
...
sre.MathspeakUtil.removeParens = function(a) {
  if (!a.childNodes.length || !a.childNodes[0].childNodes.length || !a.childNodes[0].childNodes[0].childNodes.length)
    return "";
...
sre.Locale.combinePostfixIndex = function(a, b) {
  return a === sre.Messages.MS.ROOTINDEX || a === sre.Messages.MS.INDEX ? a : a + " " + b;
};
...
sre.Grammar.getInstance().setCorrection("localEnclose", sre.Locale.localEnclose);
sre.Locale.en = {
  MS: {
    START: "Start",
    FRAC_V: "Fraction",
...
sre.AuditoryDescription.prototype.equals = function(a) {
  return (
    this.context == a.context && this.text == a.text && this.userValue == a.userValue && this.annotation == a.annotation
  );
};
  ...
  switch (b.type) {
    case sre.SpeechRule.Type.TEXT:
      if ('"' == a[0]) {
        ...
        if ('"' != c.slice(-1)) throw new sre.SpeechRule.OutputError("Invalid string syntax.");
        b.content = c;
...
sre.SpeechRule.Component.prototype.getGrammar = function() {
  ...
  for (b in this.grammar)
    !0 === this.grammar[b] ? a.push(b) : !1 === this.grammar[b] ? a.push("!" + b) : a.push(b + "=" + this.grammar[b]);
  return a;
};
sre.SpeechRule.Component.attributesFromString = function(a) {
  if ("(" != a[0] || ")" != a.slice(-1)) throw new sre.SpeechRule.OutputError("Invalid attribute expression: " + a);
  var b = {};
  ...
  for (var c = 0, d = a.length; c < d; c++) {
    ...
    if (-1 == f) b[e.trim()] = "true";
      ...
      e = e.slice(f + 1).trim();
      b[g] = "grammar" === g ? sre.SpeechRule.Component.grammarFromString(e) : (b[g] = e);
    }
  }
  return b;
};
...
sre.SpeechRule.splitString_ = function(a, b) {
  for (var c = [], d = ""; "" != a; ) {
    ...
    if (-1 == e) {
      ...
      if (-1 == f) throw new sre.SpeechRule.OutputError("Invalid string in expression: " + a);
...
sre.SpeechRuleFunctions.Store_.prototype.addStore = function(a) {
  for (var b = Object.keys(a.store_), c = 0, d; (d = b[c]); c++) this.add(d, a.store_[d]);
};
...
sre.SpeechRuleFunctions.Store_.prototype.checkCustomFunctionSyntax_ = function(a) {
  return a.match(new RegExp("^" + this.prefix_))
    ? !0
    : (console.log("FunctionError: Invalid function name. Expected prefix " + this.prefix_), !1);
};
...
sre.StaticTrieNode.prototype.setRule = function(a) {
  this.rule_ && sre.Debugger.getInstance().output("Replacing rule " + this.rule_ + " with " + a);
  this.rule_ = a;
};
...
sre.TrieNodeFactory.constraintTest_ = function(a) {
  ...
  if (a.match(/^self::\w+:\w+$/)) {
    ...
    b = a[3].toUpperCase();
    return function(a) {
      return a.localName && a.localName.toUpperCase() === b && a.namespaceURI === c;
    };
  }
  if (a.match(/^@\w+$/)) {
    var d = a.slice(1);
...
sre.QueryTrieNode.prototype.applyTest = function(a) {
  return this.test ? this.test(a) : this.store_.applyQuery(a, this.constraint) === a;
};
...
sre.BooleanTrieNode.prototype.applyTest = function(a) {
  return this.test ? this.test(a) : this.store_.applyConstraint(a, this.constraint);
};
sre.Trie = function(a) {
  this.store = a;
  this.root = sre.TrieNodeFactory.getNode(sre.TrieNode.Kind.ROOT, "", this.store);
};
sre.Trie.prototype.addRule = function(a) {
  for (var b = this.root, c = a.dynamicCstr.getValues(), d = 0, e = c.length; d < e; d++)
  ...
  d = 0;
  for (e = c.length; d < e; d++) b = this.addNode_(b, c[d], sre.TrieNode.Kind.BOOLEAN);
  b.setRule(a);
};
  ...
  for (var c = [this.root], d = []; b.length; ) {
    for (var e = b.shift(), f = []; c.length; ) {
      ...
      g.forEach(function(a) {
        (a.getKind() === sre.TrieNode.Kind.DYNAMIC && -1 === e.indexOf(a.getConstraint())) || f.push(a);
      });
    }
    c = f.slice();
  }
  for (; c.length; )
    (g = c.shift()), g.getRule && (b = g.getRule()) && d.push(b), (g = g.findChildren(a)), (c = c.concat(g));
  return d;
};
sre.Trie.prototype.hasSubtrie = function(a) {
  for (var b = this.root, c = 0, d = a.length; c < d; c++) if (((b = b.getChild(a[c])), !b)) return !1;
  return !0;
};
...
sre.Trie.collectRules_ = function(a) {
  ...
  for (a = [a]; a.length; ) {
    var c = a.shift();
    if (c.getKind() === sre.TrieNode.Kind.QUERY || c.getKind() === sre.TrieNode.Kind.BOOLEAN) {
      var d = c.getRule();
      d && b.unshift(d);
    }
...
sre.BaseRuleStore.prototype.defineRule = function(a, b, c, d, e) {
  try {
    ...
    if ("RuleError" == m.name) return console.log("Rule Error ", d, "(" + b + "):", m.message), null;
    throw m;
  }
  this.addRule(l);
  return l;
...
sre.BaseRuleStore.prototype.pickMostConstraint_ = function(a, b) {
  ...
  b.sort(function(a, b) {
    return (
      c.compare(a.dynamicCstr, b.dynamicCstr) || b.precondition.constraints.length - a.precondition.constraints.length
    );
  });
...
sre.BaseRuleStore.comparePreconditions_ = function(a, b) {
  a = a.precondition;
  b = b.precondition;
  return a.query != b.query ? !1 : sre.BaseRuleStore.compareStaticConstraints_(a.constraints, b.constraints);
};
...
sre.MathStore.prototype.defineUniqueRuleAlias = function(a, b, c, d) {
  ...
  if (!f) throw new sre.SpeechRule.OutputError("Rule named " + a + " with style " + b + " does not exist.");
...
sre.MathStore.prototype.defineRuleAlias = function(a, b, c) {
  ...
  if (!d) throw new sre.SpeechRule.OutputError("Rule with named " + a + " does not exist.");
...
sre.MathStore.prototype.defineRulesAlias = function(a, b, c) {
  ...
  if (0 == d.length) throw new sre.SpeechRule.OutputError("Rule with name " + a + " does not exist.");
...
sre.WalkerUtil.getSemanticRoot = function(a) {
  if (a.hasAttribute(sre.EnrichMathml.Attribute.TYPE) && !a.hasAttribute(sre.EnrichMathml.Attribute.PARENT)) return a;
...
sre.WalkerUtil.getBySemanticId = function(a, b) {
  return a.getAttribute(sre.EnrichMathml.Attribute.ID) === b
    ? a
    : sre.DomUtil.querySelectorAllByAttrValue(a, sre.EnrichMathml.Attribute.ID, b)[0];
};
...
sre.RebuildStree.prototype.assembleTree = function(a) {
  var b = this.makeNode(a),
    c = sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(a, sre.EnrichMathml.Attribute.CHILDREN)),
    d = sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(a, sre.EnrichMathml.Attribute.CONTENT));
  if (0 === d.length && 0 === c.length) return (b.textContent = a.textContent), b;
  if (0 < d.length) {
    var e = sre.WalkerUtil.getBySemanticId(a, d[0]);
    e &&
      ((e = sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(e, sre.EnrichMathml.Attribute.OPERATOR))),
...
sre.RebuildStree.isPunctuated = function(a) {
  return (
    !sre.SemanticSkeleton.simpleCollapseStructure(a) && a[1] && sre.SemanticSkeleton.contentCollapseStructure(a[1])
  );
};
...
sre.RebuildStree.prototype.makeIndex = function(a, b, c) {
  sre.RebuildStree.isPunctuated(b)
    ...
    : sre.SemanticSkeleton.simpleCollapseStructure(b) && !this.nodeDict[b.toString()] && this.makeEmpty(a, b, c);
};
sre.RebuildStree.prototype.postProcess = function(a, b) {
  ...
  if (a.type === sre.SemanticAttr.Type.SUBSCRIPT)
    return this.makeIndex(a, b[2], sre.SemanticAttr.Role.RIGHTSUB), this.collapsedChildren_(b), a;
  if (a.type === sre.SemanticAttr.Type.SUPERSCRIPT)
    return this.makeIndex(a, b[2], sre.SemanticAttr.Role.RIGHTSUPER), this.collapsedChildren_(b), a;
  ...
  if (a.type === sre.SemanticAttr.Type.PUNCTUATED)
    return (
      sre.RebuildStree.isPunctuated(b) &&
        ((b = b.splice(1, 1)[0].slice(1)), (a.contentNodes = b.map(goog.bind(this.makePunctuation, this)))),
      a
    );
  a.type === sre.SemanticAttr.Role.UNDEROVER &&
    ((c = this.createNode(b[1][0])),
    a.childNodes[1].role === sre.SemanticAttr.Role.OVERACCENT
      ? ((c.type = sre.SemanticAttr.Type.OVERSCORE), (a.type = sre.SemanticAttr.Type.UNDERSCORE))
      : ((c.type = sre.SemanticAttr.Type.UNDERSCORE), (a.type = sre.SemanticAttr.Type.OVERSCORE)),
...
sre.RebuildStree.prototype.collapsedChildren_ = function(a) {
  var b = goog.bind(function(a) {
    ...
    for (var e = 1, f = a.length; e < f; e++) {
      var g = a[e];
      c.childNodes.push(sre.SemanticSkeleton.simpleCollapseStructure(g) ? this.nodeDict[g] : b(g));
    }
    return c;
  }, this);
  b(a);
...
sre.MathSimpleStore.prototype.lookupRule = function(a, b) {
  ...
  return a.length
    ? a.sort(function(a, b) {
        return sre.Engine.getInstance().comparator.compare(a.dynamicCstr, b.dynamicCstr);
      })[0]
    : null;
};
...
sre.MathMap.FUNCTIONS_FILES_ = ["algebra.js", "elementary.js", "hyperbolic.js", "trigonometry.js"];
...
sre.MathMap.retrieveFiles = function(a, b, c) {
  ...
  switch (sre.Engine.getInstance().mode) {
    ...
    case sre.Engine.Mode.HTTP:
      ...
      sre.MathMap.toFetch_ += a.length;
      for (d = 0; (e = a[d]); d++) f ? sre.MathMap.getJsonIE_(e, c) : sre.MathMap.getJsonAjax_(b + e, c);
      break;
    default:
...
sre.AbstractionRules.initAbstractionRules_ = function() {
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-identifier", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-number",
    "mathspeak.default",
    '[t] "long number"',
  ...
  (0, sre.AbstractionRules.defineRule_)("abstr-text", "mathspeak.default", '[t] "text"', "self::text", "@alternative");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-function",
    "mathspeak.default",
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-sqrt", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-sqrt", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-sqrt-nested",
    "mathspeak.default",
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-sqrt-nested", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-sqrt-nested", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-root",
    "mathspeak.default",
  ...
  (0, sre.AbstractionRules.defineRule_)("abstr-root", "mathspeak.brief", '[t] "root"', "self::root", "@alternative");
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-root-nested", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-superscript",
    "mathspeak.default",
    '[t] "power"',
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-superscript", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-superscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-subscript",
    "mathspeak.default",
    '[t] "subscript"',
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-subscript", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-subscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-subsup",
    "mathspeak.default",
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-subsup", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-subsup", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-infixop",
    "mathspeak.default",
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-squarematrix", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-rowvector",
    "mathspeak.default",
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-relation", "mathspeak.default", "mathspeak.brief");
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-table", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-table", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-line",
    "mathspeak.default",
  ...
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-row", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionRules.defineSpecialisedRule_)("abstr-row", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.AbstractionRules.defineRule_)(
    "abstr-cell",
    "mathspeak.default",
    '[t] "in"; [t] @role (grammar:localRole);',
...
sre.AbstractionSpanish.initAbstractionSpanish_ = function() {
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-identifier", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-number",
    "mathspeak.default",
    '[t] "n\u00famero largo"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-number", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-mixed-number",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-mixed-number", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-text",
    "mathspeak.default",
    '[t] "texto"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-function", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-lim",
    "mathspeak.default",
    '[t] "funci\u00f3n de l\u00edmite"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-lim", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-fraction",
    "mathspeak.default",
    '[t] "fracci\u00f3n"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-fraction", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-continued-fraction",
    "mathspeak.default",
    '[t] "fracci\u00f3n continua"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-continued-fraction", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-sqrt",
    "mathspeak.default",
    '[t] "ra\u00edz cuadrada"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-sqrt", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-sqrt", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-sqrt-nested",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-sqrt-nested", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-sqrt-nested", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-root",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-root", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-root-nested",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-root-nested", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-superscript",
    "mathspeak.default",
    '[t] "potencia"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-superscript", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-superscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-subscript",
    "mathspeak.default",
    '[t] "sub\u00edndice"',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-subscript", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-subscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-subsup",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-subsup", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-subsup", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-infixop",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-infixop", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-addition",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-addition", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-addition",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-multiplication", "mathspeak.brief", "mathspeak.sbrief");
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-vector", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-vector",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-binomial", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-binomial", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-determinant",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-determinant", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-determinant",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-squarematrix", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-rowvector",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-rowvector", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-matrix",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-matrix", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-matrix",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-cases", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-cases",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-punctuated", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-punctuated",
    "mathspeak.default",
    '[t] "lista separada por"; [n] content/*[1]',
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-relation", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-relation", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-relation",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-multirel", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-var-multirel",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-table", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-table", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-line",
    "mathspeak.default",
  ...
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-row", "mathspeak.default", "mathspeak.brief");
  (0, sre.AbstractionSpanish.defineSpecialisedRule_)("abstr-row", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.AbstractionSpanish.defineRule_)(
    "abstr-cell",
    "mathspeak.default",
    '[t] "en"; [t] @role (grammar:localRole);',
...
sre.AbstractionSpanish.getInstance().initializer = [sre.AbstractionSpanish.initAbstractionSpanish_];
...
sre.MathmlStoreUtil.checkMathjaxTag = function(a, b) {
  return (a = sre.MathmlStoreUtil.matchMathjaxToMathml(a)) && a.tagName.toUpperCase() == b ? [a] : [];
};
...
sre.EmacspeakRules.defineRule_ = goog.bind(sre.EmacspeakRules.mathStore.defineRule, sre.EmacspeakRules.mathStore);
...
sre.EmacspeakRules.initCustomFunctions_ = function() {
  ...
  (0, sre.EmacspeakRules.addContextFunction_)("CTXFcontentIterator", sre.MathmlStoreUtil.contentIterator);
  (0, sre.EmacspeakRules.addCustomQuery_)("CQFvulgarFractionSmall", sre.MathspeakUtil.isSmallVulgarFraction);
  (0, sre.EmacspeakRules.addCustomString_)("CSFvulgarFraction", sre.MathspeakUtil.vulgarFraction);
};
sre.EmacspeakRules.initSemanticRules_ = function() {
  (0, sre.EmacspeakRules.defineRule_)("stree", "emacspeak.default", "[n] ./*[1]", "self::stree");
  ...
  (0, sre.EmacspeakRules.defineRule_)("identifier", "emacspeak.default", "[n] text()", "self::identifier");
  (0, sre.EmacspeakRules.defineRule_)("number", "emacspeak.default", "[n] text()", "self::number");
  (0, sre.EmacspeakRules.defineRule_)(
    "font",
    "mathspeak.default",
  ...
  (0, sre.EmacspeakRules.defineRuleAlias_)("fence-single", "self::punctuation", 'self::punctuation[@role="vbar"]');
  (0, sre.EmacspeakRules.defineRuleAlias_)(
    "fence-single",
    "self::punctuation",
    'self::punctuation[@role="application"]'
  );
  (0, sre.EmacspeakRules.defineRule_)("omit-empty", "emacspeak.default", "[p] (pause:100)", "self::empty");
  (0, sre.EmacspeakRules.defineRule_)(
    "fences-open-close",
    "emacspeak.default",
  ...
  (0, sre.EmacspeakRules.defineRule_)("cases-row", "emacspeak.default", "[m] children/*", 'self::row[@role="cases"]');
  (0, sre.EmacspeakRules.defineRule_)(
    "cases-cell",
    "emacspeak.default",
    "[n] children/*[1]",
  ...
  (0, sre.EmacspeakRules.defineRule_)("line", "emacspeak.default", "[m] children/*", "self::line");
  (0, sre.EmacspeakRules.defineRule_)(
    "table",
    "emacspeak.default",
  ...
  (0, sre.EmacspeakRules.defineRuleAlias_)("cases-cell", 'self::cell[@role="table"]');
  (0, sre.EmacspeakRules.defineRule_)(
    "end-punct",
    "emacspeak.default",
  ...
  (0, sre.EmacspeakRules.defineRule_)("function", "emacspeak.default", "[n] text()", "self::function");
  (0, sre.EmacspeakRules.defineRule_)(
    "appl",
    "emacspeak.default",
  ...
  (0, sre.EmacspeakRules.defineRule_)("largeop", "emacspeak.default", "[n] text()", "self::largeop");
  (0, sre.EmacspeakRules.defineRule_)(
    "bigop",
    "emacspeak.default",
  ...
  (0, sre.EmacspeakRules.defineRule_)("text", "emacspeak.default", "[n] text(); [p] (pause:200)", "self::text");
  (0, sre.EmacspeakRules.defineRule_)(
    "unit",
    "emacspeak.default",
...
sre.MathmlStoreRules.initCustomFunctions_ = function() {
  ...
  (0, sre.MathmlStoreRules.addCustomQuery_)("CQFmathmlmover", sre.MathmlStoreUtil.checkMathjaxMover);
...
sre.MathmlStoreRules.initDefaultRules_ = function() {
  ...
  (0, sre.MathmlStoreRules.defineDefaultMathmlRule_)("ms", '[t] "string" (pitch:0.5, rate:0.5); [t] text()');
  (0, sre.MathmlStoreRules.defineRule_)(
    "unit",
    "default.default",
...
sre.MathspeakRules.initCustomFunctions_ = function() {
  ...
  (0, sre.MathspeakRules.addCustomString_)("CSFbaselineVerbose", sre.MathspeakUtil.baselineVerbose);
  ...
  (0, sre.MathspeakRules.addContextFunction_)("CTXFordinalCounter", sre.MathspeakUtil.ordinalCounter);
  ...
  (0, sre.MathspeakRules.addCustomString_)("CSFRemoveParens", sre.MathspeakUtil.removeParens);
  (0, sre.MathspeakRules.addCustomQuery_)("CQFresetNesting", sre.MathspeakUtil.resetNestingDepth);
};
sre.MathspeakRules.initMathspeakRules_ = function() {
  (0, sre.MathspeakRules.defineRule_)("stree", "mathspeak.default", "[n] ./*[1]", "self::stree", "CQFresetNesting");
  ...
  (0, sre.MathspeakRules.defineRule_)("omit-empty", "mathspeak.default", "[p] (pause:100)", "self::empty");
  ...
  (0, sre.MathspeakRules.defineRule_)("prefix", "mathspeak.default", "[n] text(); [n] children/*[1]", "self::prefixop");
  (0, sre.MathspeakRules.defineRule_)(
    "postfix",
    "mathspeak.default",
    "[n] children/*[1]; [n] text()",
  ...
  (0, sre.MathspeakRules.defineRule_)("minus", "mathspeak.default", '[t] "minus"', "self::operator", 'text()="-"');
  (0, sre.MathspeakRules.defineRule_)(
    "single-prime",
    "mathspeak.default",
    '[t] "prime"',
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("vulgar-fraction", "mathspeak.default", "mathspeak.brief");
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("subscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakRules.defineRule_)(
    "subscript-simple",
    "mathspeak.default",
    "[n] children/*[1]; [n] children/*[2]",
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("subscript-simple", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.MathspeakRules.defineRule_)(
    "subscript-baseline",
    "mathspeak.default",
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("row-with-label", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakRules.defineRule_)(
    "row-with-text-label",
    "mathspeak.sbrief",
  ...
  (0, sre.MathspeakRules.defineRule_)("line", "mathspeak.default", "[m] children/*", "self::line");
  (0, sre.MathspeakRules.defineRule_)(
    "line-with-label",
    "mathspeak.default",
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("line-with-label", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakRules.defineRule_)(
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("empty-line", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakRules.defineSpecialisedRule_)("empty-line", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakRules.defineRule_)(
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("empty-line-with-label", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakRules.defineRule_)(
    "enclose",
    "mathspeak.default",
  ...
  (0, sre.MathspeakRules.defineSpecialisedRule_)("cancel-reverse", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.MathspeakRules.defineRuleAlias_)(
    "cancel-reverse",
    "self::underscore",
    'name(children/*[2])="enclose"',
...
sre.MathspeakRules.generateMathspeakTensorRules_ = function() {
  for (
    var a = "11111 11110 11101 11100 10111 10110 10101 10100 01111 01110 01101 01100".split(" "), b = 0, c;
    (c = a[b]);
    b++
  ) {
    var d = "tensor" + c;
...
sre.Grammar.getInstance().setCorrection("euroNum", sre.MathspeakSpanishUtil.europeanNumber);
...
sre.MathspeakSpanishUtil.smallRoot = function(a) {
  if (!a.childNodes || 0 === a.childNodes.length || !a.childNodes[0].childNodes) return [];
...
sre.MathspeakSpanishUtil.unitMultipliers = function(a, b) {
  ...
  return function() {
    var b = sre.AuditoryDescription.create(
      {
        text:
          sre.MathspeakSpanishUtil.rightMostUnit(a[c]) && sre.MathspeakSpanishUtil.leftMostUnit(a[c + 1]) ? "por" : ""
      },
      {}
    );
    c++;
...
sre.MathspeakSpanishUtil.rightMostUnit = function(a) {
  for (; a; ) {
    ...
    a = -1 !== sre.MathspeakSpanishUtil.SCRIPT_ELEMENTS.indexOf(b) ? a[0] : a[a.length - 1];
  }
  return !1;
};
...
sre.Grammar.getInstance().setCorrection("plural", sre.MathspeakSpanishUtil.makePlural);
sre.MathspeakSpanishUtil.oneLeft = function(a) {
  for (; a; ) {
    if ("number" === a.tagName && "1" === a.textContent) return [a];
    if (
      "infixop" !== a.tagName ||
      ("multiplication" !== a.getAttribute("role") && "implicit" !== a.getAttribute("role"))
    )
      break;
    a = sre.XpathUtil.evalXPath("children/*", a)[0];
  }
...
sre.MathspeakSpanish.evaluateDefault = function(a) {
  ...
  for (
    ...
    else (f = e.exec(a)), (g = sre.Semantic.Type.UNKNOWN), (h = sre.Semantic.Role.TEXT);
    g = c.parseFromString("<" + g + ' role="' + h + '">' + f[0] + "</" + g + ">", "text/xml");
...
sre.MathspeakSpanish.defineRule_ = goog.bind(sre.MathspeakSpanish.mathStore.defineRule, sre.MathspeakSpanish.mathStore);
...
sre.MathspeakSpanish.initCustomFunctions_ = function() {
  (0, sre.MathspeakSpanish.addCustomQuery_)("CQFspaceoutNumber", sre.MathspeakUtil.spaceoutNumber);
  (0, sre.MathspeakSpanish.addCustomQuery_)("CQFspaceoutIdentifier", sre.MathspeakUtil.spaceoutIdentifier);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFspaceoutText", sre.MathspeakUtil.spaceoutText);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFopenFracVerbose", sre.MathspeakUtil.openingFractionVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFcloseFracVerbose", sre.MathspeakUtil.closingFractionVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFoverFracVerbose", sre.MathspeakUtil.overFractionVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFopenFracBrief", sre.MathspeakUtil.openingFractionBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFcloseFracBrief", sre.MathspeakUtil.closingFractionBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFopenFracSbrief", sre.MathspeakUtil.openingFractionSbrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFcloseFracSbrief", sre.MathspeakUtil.closingFractionSbrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFoverFracSbrief", sre.MathspeakUtil.overFractionSbrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFopenRadicalVerbose", sre.MathspeakUtil.openingRadicalVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFcloseRadicalVerbose", sre.MathspeakUtil.closingRadicalVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFindexRadicalVerbose", sre.MathspeakUtil.indexRadicalVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFopenRadicalBrief", sre.MathspeakUtil.openingRadicalBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFcloseRadicalBrief", sre.MathspeakUtil.closingRadicalBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFindexRadicalBrief", sre.MathspeakUtil.indexRadicalBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFopenRadicalSbrief", sre.MathspeakUtil.openingRadicalSbrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFindexRadicalSbrief", sre.MathspeakUtil.indexRadicalSbrief);
  (0, sre.MathspeakSpanish.addCustomQuery_)("CQFisSmallRoot", sre.MathspeakSpanishUtil.smallRoot);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFsuperscriptVerbose", sre.MathspeakUtil.superscriptVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFsuperscriptBrief", sre.MathspeakUtil.superscriptBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFsubscriptVerbose", sre.MathspeakUtil.subscriptVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFsubscriptBrief", sre.MathspeakUtil.subscriptBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFbaselineVerbose", sre.MathspeakUtil.baselineVerbose);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFbaselineBrief", sre.MathspeakUtil.baselineBrief);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFunderscript", sre.MathspeakUtil.nestedUnderscore);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFoverscript", sre.MathspeakUtil.nestedOverscore);
  (0, sre.MathspeakSpanish.addContextFunction_)("CTXFordinalCounterEs", sre.MathspeakSpanishUtil.ordinalCounter);
  (0, sre.MathspeakSpanish.addContextFunction_)("CTXFcontentIterator", sre.MathmlStoreUtil.contentIterator);
  (0, sre.MathspeakSpanish.addContextFunction_)("CTXFunitMultipliers", sre.MathspeakSpanishUtil.unitMultipliers);
  (0, sre.MathspeakSpanish.addCustomQuery_)("CQFdetIsSimple", sre.MathspeakUtil.determinantIsSimple);
  (0, sre.MathspeakSpanish.addCustomString_)("CSFRemoveParens", sre.MathspeakUtil.removeParens);
  (0, sre.MathspeakSpanish.addCustomQuery_)("CQFoneLeft", sre.MathspeakSpanishUtil.oneLeft);
  (0, sre.MathspeakSpanish.addCustomQuery_)("CQFresetNesting", sre.MathspeakUtil.resetNestingDepth);
  (0, sre.MathspeakSpanish.addCustomQuery_)("CQFtextEvaluator", sre.MathspeakSpanish.evaluateDefault);
};
sre.MathspeakSpanish.initMathspeakSpanish_ = function() {
  (0, sre.MathspeakSpanish.defineRule_)("stree", "mathspeak.default", "[n] ./*[1]", "self::stree", "CQFresetNesting");
  (0, sre.MathspeakSpanish.defineRule_)("unknown", "mathspeak.default", "[n] text()", "self::unknown");
  (0, sre.MathspeakSpanish.defineRule_)("protected", "mathspeak.default", "[t] text()", "self::*", '@role="protected"');
  (0, sre.MathspeakSpanish.defineRule_)("omit-empty", "mathspeak.default", "[p] (pause:100)", "self::empty");
  ...
  (0, sre.MathspeakSpanish.defineRule_)("number", "mathspeak.default", "[n] text() (grammar:euroNum)", "self::number");
  (0, sre.MathspeakSpanish.defineRule_)(
    "mixed-number",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("number-with-chars", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "number-as-upper-word",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("number-baseline", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "number-baseline-font",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("number-baseline-font", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "identifier",
    "mathspeak.default",
    "[m] CQFspaceoutIdentifier",
  ...
  (0, sre.MathspeakSpanish.defineRuleAlias_)("negative", "self::prefixop", '@role="negative"', "children/number");
  ...
  (0, sre.MathspeakSpanish.defineRule_)("text", "mathspeak.default", "[m] CQFtextEvaluator", "self::text");
  (0, sre.MathspeakSpanish.defineRule_)(
    "factorial",
    "mathspeak.default",
    '[t] "factorial"',
  ...
  (0, sre.MathspeakSpanish.defineRule_)("minus", "mathspeak.default", '[t] "menos"', "self::operator", 'text()="-"');
  (0, sre.MathspeakSpanish.defineRule_)(
    "single-prime",
    "mathspeak.default",
    '[t] "prima"',
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("continued-fraction-outer", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "continued-fraction-inner",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineRuleAlias_)("limlower-end", "self::underscore", '@role="limit function"');
  (0, sre.MathspeakSpanish.defineRuleAlias_)("limlower-end", "self::underscore");
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("integral", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "bigop",
    "mathspeak.default",
    "[n] children/*[1]; [n] children/*[2];",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("subscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "subscript-baseline",
    "mathspeak.default",
    "[n] children/*[1]; [t] CSFsubscriptVerbose; [n] children/*[2]; [t] CSFbaselineVerbose",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("subscript-baseline", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRuleAlias_)(
    "subscript-baseline",
    "self::subscript",
    "not(following-sibling::*)",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("subscript-empty-sup", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("subscript-empty-sup", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRuleAlias_)(
    "subscript-empty-sup",
    "self::subscript",
    'name(children/*[2])="superscript"',
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("superscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "superscript-baseline",
    "mathspeak.default",
    "[n] children/*[1]; [t] CSFsuperscriptVerbose; [n] children/*[2];[t] CSFbaselineVerbose",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("superscript-baseline", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRuleAlias_)(
    "superscript-baseline",
    "self::superscript",
    "not(following-sibling::*)",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("superscript-empty-sub", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("superscript-empty-sub", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRuleAlias_)(
    "superscript-empty-sub",
    "self::superscript",
    'name(children/*[2])="subscript"',
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("square", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("square", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "cube",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("cube", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("cube", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "prime",
    "mathspeak.default",
    "[n] children/*[1]; [n] children/*[2]",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("prime", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("prime", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "prime-subscript",
    "mathspeak.default",
    "[n] children/*[1]/children/*[1]; [n] children/*[2]; [t] CSFsubscriptVerbose; [n] children/*[1]/children/*[2]",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("prime-subscript", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "prime-subscript-baseline",
    "mathspeak.default",
    "[n] children/*[1]/children/*[1]; [n] children/*[2]; [t] CSFsubscriptVerbose; [n] children/*[1]/children/*[2]; [t] CSFbaselineVerbose",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("prime-subscript-baseline", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRuleAlias_)(
    "prime-subscript-baseline",
    "self::superscript",
    'children/*[2][@role="prime"]',
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("overscore", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "double-overscore",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("double-overscore", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "underscore",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("underscore", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "double-underscore",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("double-underscore", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "overbar",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("overbar", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "underbar",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("underbar", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "overtilde",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("overtilde", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "undertilde",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("undertilde", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "matrix-fence",
    "mathspeak.default",
    "[n] children/*[1];",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("row-with-label", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "row-with-text-label",
    "mathspeak.sbrief",
  ...
  (0, sre.MathspeakSpanish.defineRule_)("line", "mathspeak.default", "[m] children/*", "self::line");
  (0, sre.MathspeakSpanish.defineRule_)(
    "line-with-label",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("line-with-label", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "line-with-text-label",
    "mathspeak.sbrief",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("empty-line", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("empty-line", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "empty-line-with-label",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("empty-line-with-label", "mathspeak.brief", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRule_)(
    "enclose",
    "mathspeak.default",
  ...
  (0, sre.MathspeakSpanish.defineRuleAlias_)("overbar", "self::enclose", '@role="top"');
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("cancel", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("cancel", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRuleAlias_)(
    "cancel",
    "self::underscore",
    '@role="updiagonalstrike" or @role="downdiagonalstrike" or @role="horizontalstrike"'
  ...
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("cancel-reverse", "mathspeak.default", "mathspeak.brief");
  (0, sre.MathspeakSpanish.defineSpecialisedRule_)("cancel-reverse", "mathspeak.default", "mathspeak.sbrief");
  (0, sre.MathspeakSpanish.defineRuleAlias_)(
    "cancel-reverse",
    "self::underscore",
    'name(children/*[2])="enclose"',
  ...
  (0, sre.MathspeakSpanish.defineRule_)("punctuated", "mathspeak.default", "[m] children/*", "self::punctuated");
  (0, sre.MathspeakSpanish.defineRule_)(
    "unit",
    "mathspeak.default",
    '[t] text() (grammar:annotation="unit":translate)',
...
sre.MathspeakSpanish.generateMathspeakTensorRules_ = function() {
  for (
    ...
    (0, sre.MathspeakSpanish.defineSpecialisedRule_)(d, "mathspeak.brief", "mathspeak.sbrief");
...
sre.PrefixRules.defineRuleAlias_ = goog.bind(sre.PrefixRules.mathStore.defineRulesAlias, sre.PrefixRules.mathStore);
...
sre.PrefixSpanish.defineRule_ = goog.bind(sre.PrefixSpanish.mathStore.defineRule, sre.PrefixSpanish.mathStore);
...
sre.SemanticTreeRules.initSemanticRules_ = function() {
  ...
  (0, sre.SemanticTreeRules.defineRule_)("identifier", "default.default", "[n] text()", "self::identifier");
  ...
  (0, sre.SemanticTreeRules.defineRule_)("omit-empty", "default.default", "[p] (pause:100)", "self::empty");
  (0, sre.SemanticTreeRules.defineRule_)(
    "fences-open-close",
    "default.default",
  ...
  for (var e = 0, f; (f = b[e]); e++) {
    ...
    switch (f.type) {
      ...
      case sre.SpeechRule.Type.MULTI:
        ...
        break;
      case sre.SpeechRule.Type.TEXT:
        (h = this.constructString(a, h)) && (g = [sre.AuditoryDescription.create({ text: h }, { adjust: !0 })]);
        break;
      default:
    ...
    g[0] &&
      ...
      (k.context && (g[0].context = this.constructString(a, k.context) + (g[0].context || "")),
...
sre.SpeechRuleEngine.debugNamedSpeechRule = function(a, b) {
  ...
  if (c)
    for (
      ...
      sre.Debugger.getInstance().output("Rule", a, "DynamicCstr:", f.dynamicCstr.toString(), "number", e),
...
sre.SpeechRuleEngine.prototype.runInSetting = function(a, b) {
  ...
  for (f in a)
    "rules" === f
      ? ((e = this.activeStore_), (c.ruleSets = a[f]), this.parameterize(c.ruleSets))
      : ((d[f] = c[f]), (c[f] = a[f]));
...
sre.SpeechRuleEngine.prototype.updateEngine = function() {
  ...
  sre.Engine.isReady()
    ? (sre.Engine.getInstance().evaluator = goog.bind(a.store.lookupString, a.store))
...
sre.SpeechRuleEngine.prototype.updateConstraint_ = function() {
  var a = sre.Engine.getInstance().dynamicCstr,
    ...
    c = {},
    d = [a.getValue(sre.DynamicCstr.Axis.LOCALE), a.getValue(sre.DynamicCstr.Axis.DOMAIN)],
...
sre.SpeechGeneratorUtil.retrieveSpeech = function(a) {
  var b = null;
  sre.Engine.getInstance().cache && (b = sre.SpeechRuleEngine.getInstance().getCache(a.id.toString()));
...
sre.SpeechGeneratorUtil.addPrefix = function(a, b) {
  (b = sre.SpeechGeneratorUtil.retrievePrefix(b)) && a.setAttribute(sre.EnrichMathml.Attribute.PREFIX, b);
};
  ...
  for (var d = 0, e; (e = b[d]); d++) {
    ...
    if ((f = sre.DomUtil.querySelectorAllByAttrValue(a, "id", f)[0])) {
      ...
      (h && "dummy" !== h.getAttribute(sre.EnrichMathml.Attribute.TYPE)) ||
        ((h = f.childNodes[0]),
        (f = g.getAttribute(sre.EnrichMathml.Attribute.PARENT)) && h.setAttribute(sre.EnrichMathml.Attribute.PARENT, f),
        h.setAttribute(sre.EnrichMathml.Attribute.TYPE, "dummy"),
        h.setAttribute(sre.EnrichMathml.Attribute.ID, e),
        sre.DomUtil.querySelectorAllByAttrValue(c, "id", e)[0].setAttribute("alternative", e));
    }
  }
};
sre.SpeechGeneratorUtil.connectAllMactions = function(a, b) {
  ...
  for (var c = 0, d; (d = a[c]); c++)
    (d = d.childNodes[1].getAttribute(sre.EnrichMathml.Attribute.ID)),
      sre.DomUtil.querySelectorAllByAttrValue(b, "id", d)[0].setAttribute("alternative", d);
};
...
sre.TreeSpeechGenerator.prototype.getSpeech = function(a, b) {
  ...
  for (e in d) {
    ...
    g && h && (sre.SpeechGeneratorUtil.addSpeech(h, f), sre.SpeechGeneratorUtil.addPrefix(h, f));
  }
  return c;
};
...
sre.SpeechGeneratorFactory.generator = function(a) {
  return new (sre.SpeechGeneratorFactory.generatorMapping_[a] || sre.SpeechGeneratorFactory.generatorMapping_.Direct)();
};
...
sre.AbstractWalker.prototype.deactivate = function() {
  this.isActive() &&
    (this.highlighter.setState(this.node.id, this.primaryId()), this.generator.end(), this.toggleActive_());
};
...
sre.AbstractWalker.prototype.speech = function() {
  ...
  switch (this.moved) {
    ...
    default:
      b = [];
      for (var c = this.focus_.getSemanticNodes(), d = 0, e = a.length; d < e; d++) {
        var f = a[d],
          g = c[d];
        b.push(f ? this.generator.getSpeech(f, this.xml) : sre.SpeechGeneratorUtil.retrieveSpeech(g));
      }
...
sre.AbstractWalker.prototype.nextLevel = function() {
  var a = this.focus_.getDomPrimary();
  if (a) {
    var b = sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(a, sre.EnrichMathml.Attribute.CHILDREN)),
      c = sre.WalkerUtil.splitAttribute(sre.WalkerUtil.getAttribute(a, sre.EnrichMathml.Attribute.CONTENT)),
...
sre.SemanticWalker.prototype.makePairList = function(a, b) {
  ...
  for (var c = [this.singletonFocus(a.shift())], d = 0, e = a.length; d < e; d++)
...
sre.TableWalker.prototype.up = function() {
  this.moved = sre.Walker.move.UP;
  return this.eligibleCell_() ? this.verticalMove_(!1) : sre.TableWalker.superClass_.up.call(this);
};
sre.TableWalker.prototype.down = function() {
  this.moved = sre.Walker.move.DOWN;
  return this.eligibleCell_() ? this.verticalMove_(!0) : sre.TableWalker.superClass_.down.call(this);
};
...
sre.TableWalker.prototype.eligibleCell_ = function() {
  ...
  return (
    this.modifier && a.type === sre.SemanticAttr.Type.CELL && -1 !== sre.TableWalker.ELIGIBLE_CELL_ROLES.indexOf(a.role)
  );
};
...
sre.TableWalker.prototype.jumpCell = function() {
  ...
  if (this.moved === sre.Walker.move.ROW) {
    ...
    return this.isLegalJump_(this.row_, a) ? this.jumpCell_(this.row_, a) : this.getFocus();
  }
...
sre.TableWalker.prototype.isLegalJump_ = function(a, b) {
  var c = sre.DomUtil.querySelectorAllByAttrValue(this.rebuilt.xml, "id", this.currentTable_.id.toString())[0];
  if (!c || c.hasAttribute("alternative")) return !1;
  a = this.currentTable_.childNodes[a - 1];
  if (!a) return !1;
  c = sre.DomUtil.querySelectorAllByAttrValue(c, "id", a.id.toString())[0];
  return !c || c.hasAttribute("alternative") ? !1 : !(!a || !a.childNodes[b - 1]);
};
sre.TableWalker.prototype.isInTable_ = function() {
  for (var a = this.getFocus().getSemanticPrimary(); a; ) {
    if (-1 !== sre.TableWalker.ELIGIBLE_TABLE_TYPES.indexOf(a.type)) return (this.currentTable_ = a), !0;
    a = a.parent;
  }
  return !1;
};
...
sre.WalkerFactory.walker = function(a, b, c, d, e) {
  return new (sre.WalkerFactory.walkerMapping_[a] || sre.WalkerFactory.walkerMapping_.Dummy)(b, c, d, e);
};
...
sre.System.prototype.configBlocks_ = function(a) {
  if (sre.Engine.getInstance().mode === sre.Engine.Mode.HTTP)
    for (
      var b = document.documentElement.querySelectorAll('script[type="text/x-sre-config"]'), c = 0, d = b.length;
      c < d;
      c++
    )
      try {
...
sre.System.prototype.toSpeech = function(a) {
  return (a = sre.System.getInstance().parseExpression_(a, sre.Engine.getInstance().semantics))
...
sre.System.prototype.walk = function(a) {
  ...
  var c = sre.HighlighterFactory.highlighter({ color: "black" }, { color: "white" }, { renderer: "NativeMML" });
  a = sre.System.getInstance().toEnriched(a);
  var d = new sre.SystemExternal.xmldom.XMLSerializer().serializeToString(a);
  sre.System.LocalStorage_.getInstance().walker = sre.WalkerFactory.walker(sre.Engine.getInstance().walker, a, b, c, d);
...
(function() {
  ...
  MathJax.Extension.Sre = {
    ...
    ConfigSre: function() {
      sre.Engine.isReady()
        ? MathJax.Callback.Queue(MathJax.Hub.Register.StartupHook("mml Jax Ready", {}), [
            "Post",
