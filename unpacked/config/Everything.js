/*************************************************************
 *
 *  /MathJax/unpacked/config/Everything.js
 *  
...
MathJax.Hub.Config({
  ...
  jax: ["input/TeX","input/MathML","input/AsciiMath","output/SVG","output/HTML-CSS","output/NativeMML","output/CommonHTML","output/PreviewHTML"]
});

MathJax.Ajax.loadComplete("[MathJax]/config/Everything.js");
